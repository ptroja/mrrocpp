...
#if !defined(__MP_R_IRP6_POSTUMENT_H)
#define __MP_R_IRP6_POSTUMENT_H

#include "mp/mp.h"

// ---------------------------------------------------------------
class mp_irp6_postument_robot: public mp_robot {

 public:
  mp_irp6_postument_robot (mp_task* mp_object_l); // Konstruktor
