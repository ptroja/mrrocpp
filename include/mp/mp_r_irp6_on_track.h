...
#if !defined(__MP_R_IRP6_ON_TRACK_H)
#define __MP_R_IRP6_ON_TRACK_H

#include "mp/mp.h"

// ---------------------------------------------------------------
class mp_irp6_on_track_robot: public mp_robot {

 public:
  mp_irp6_on_track_robot (mp_task* mp_object_l); // Konstruktor
...
}; // end: class mp_irp6_on_track_robot
// --------------------------------------------------------------------------
