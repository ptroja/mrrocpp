...
public:
 ...
 class Fatal_error { // klasa wyjatku obslugujacego bledy fatalne
    public:
 ...
 class NonFatal_error_1 { // klasa wyjatku obslugujacego bledy, ktore nie sa fatalne, a naleza do pierwszej grupy
    public:
 ...
 class NonFatal_error_2 { // klasa wyjatku obslugujacego bledy, ktore nie sa fatalne, a naleza do drugiej grupy
    public:
       uint64_t error;   // Blad
 ...
 class NonFatal_error_3 { // klasa wyjatku obslugujacego bledy, ktore nie sa fatalne, a naleza do drugiej grupy
    public:
       uint64_t error;   // Blad powstaly przy przeliczaniu wspolrzednych
 ...
 class NonFatal_error_4 { // klasa wyjatku obslugujacego bledy, ktore nie sa fatalne
    public:
       uint64_t error;   // Blad
...
struct reader_data {   // Struktura z danymi pomiarowymi w reader do zapisu do pliku
