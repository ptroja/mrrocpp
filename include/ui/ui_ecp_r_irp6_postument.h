...
#ifndef _UI_ECP_R_IRP6_POSTUMENT_H
#define _UI_ECP_R_IRP6_POSTUMENT_H
...
// ---------------------------------------------------------------
class ui_irp6_postument_robot: public ecp_irp6_postument_robot {
...
// ecp_buffer ui_edp_package; // by Y
  ui_irp6_postument_robot (edp_state_def* edp_state, configurator &_config, sr_ecp* sr_ecp_msg); // Konstruktor
