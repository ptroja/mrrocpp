...
#ifndef _UI_ECP_R_IRP6_ON_TRACK_H
#define _UI_ECP_R_IRP6_ON_TRACK_H
...
// ---------------------------------------------------------------
class ui_irp6_on_track_robot: public ecp_irp6_on_track_robot {
...
// ecp_buffer ui_edp_package; // by Y
  ui_irp6_on_track_robot (edp_state_def* edp_state, configurator &_config, sr_ecp* sr_ecp_msg); // Konstruktor
...
}; // end: class ui_irp6_on_track_robot
#endif
