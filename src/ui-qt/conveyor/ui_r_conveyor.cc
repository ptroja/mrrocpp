...
int UiRobot::manage_interface()
{
	...
	{
		case -1:
			mw->enable_menu_item(false, 1, mw->getMenuBar()->menuConveyor);

			break;
		case 0:
			mw->enable_menu_item(false, 3, mw->getMenuBar()->actionconveyor_EDP_Unload, mw->getMenuBar()->actionconveyor_Synchronization, mw->getMenuBar()->actionconveyor_Move);
			mw->enable_menu_item(false, 1, mw->getMenuBar()->menuconveyor_Preset_Positions);
			mw->enable_menu_item(true, 1, mw->getMenuBar()->menuConveyor);
			mw->enable_menu_item(true, 1, mw->getMenuBar()->actionconveyor_EDP_Load);
		...
		case 2:
			...
			if (state.edp.is_synchronised) {
				mw->enable_menu_item(false, 1, mw->getMenuBar()->actionconveyor_Synchronization);
				...
				switch (interface.mp.state)
				{
					...
					case common::UI_MP_PERMITED_TO_RUN:
						mw->enable_menu_item(true, 2, mw->getMenuBar()->actionconveyor_EDP_Unload, mw->getMenuBar()->actionconveyor_Move);
						mw->enable_menu_item(true, 1, mw->getMenuBar()->menuconveyor_Preset_Positions);
						mw->enable_menu_item(false, 1, mw->getMenuBar()->actionconveyor_EDP_Load);

						break;
					case common::UI_MP_WAITING_FOR_START_PULSE:
						mw->enable_menu_item(true, 1, mw->getMenuBar()->actionconveyor_Move);
						mw->enable_menu_item(true, 1, mw->getMenuBar()->menuconveyor_Preset_Positions);
						mw->enable_menu_item(false, 1, mw->getMenuBar()->actionconveyor_EDP_Load, mw->getMenuBar()->actionconveyor_EDP_Unload);
			...
			{
				mw->enable_menu_item(true, 3, mw->getMenuBar()->actionconveyor_EDP_Unload, mw->getMenuBar()->actionconveyor_Synchronization, mw->getMenuBar()->actionconveyor_Move);
				mw->enable_menu_item(false, 1, mw->getMenuBar()->actionconveyor_EDP_Load);
