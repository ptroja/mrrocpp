...
void wgt_spkm_int::on_pushButton_read_clicked()
{
	init();
}
...
void wgt_spkm_int::on_pushButton_export_clicked()
{
...
void wgt_spkm_int::on_pushButton_copy_clicked()
{
	copy();
}
...
void wgt_spkm_int::on_pushButton_0l_clicked()
{
	get_desired_position();
...
void wgt_spkm_int::on_pushButton_1l_clicked()
{
	get_desired_position();
...
void wgt_spkm_int::on_pushButton_2l_clicked()
{
	get_desired_position();
...
void wgt_spkm_int::on_pushButton_3l_clicked()
{
	get_desired_position();
...
void wgt_spkm_int::on_pushButton_4l_clicked()
{
	get_desired_position();
...
void wgt_spkm_int::on_pushButton_5l_clicked()
{
	get_desired_position();
...
void wgt_spkm_int::on_pushButton_1r_clicked()
{
	get_desired_position();
	robot->desired_pos[1] += ui.doubleSpinBox_step->value();
	move_it();
...
void wgt_spkm_int::on_pushButton_2r_clicked()
{
	get_desired_position();
	robot->desired_pos[2] += ui.doubleSpinBox_step->value();
	move_it();
...
void wgt_spkm_int::on_pushButton_3r_clicked()
{
	get_desired_position();
	robot->desired_pos[3] += ui.doubleSpinBox_step->value();
	move_it();
...
void wgt_spkm_int::on_pushButton_4r_clicked()
{
	get_desired_position();
	robot->desired_pos[4] += ui.doubleSpinBox_step->value();
	move_it();
