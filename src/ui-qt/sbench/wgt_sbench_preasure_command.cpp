...
wgt_sbench_preasure_command::wgt_sbench_preasure_command(const QString & _widget_label, mrrocpp::ui::common::Interface& _interface, mrrocpp::ui::common::UiRobot *_robot, QWidget *parent) :
		wgt_sbench_command(_widget_label, _interface, _robot, parent)
{
}

void wgt_sbench_preasure_command::read_and_set()
{
	init();
...
void wgt_sbench_preasure_command::reshresh_widgets()
{
	refresh_dock_widgets(robot->ui_ecp_robot->the_robot->data_request_port.data.preasure_buf);
}
