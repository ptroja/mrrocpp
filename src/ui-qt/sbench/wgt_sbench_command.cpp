...
void wgt_sbench_command::synchro_depended_init()
{
	emit synchro_depended_init_signal();
}

void wgt_sbench_command::synchro_depended_init_slot()
{
...
int wgt_sbench_command::synchro_depended_widgets_disable(bool _set_disabled)
{
...
void wgt_sbench_command::timer_slot()
{
...
int wgt_sbench_command::get_desired_position()
{
...
int wgt_sbench_command::move_it()
{
...
void wgt_sbench_command::on_pushButton_fl_execute_clicked()
{
	try {
...
void wgt_sbench_command::on_pushButton_fl_all_up_clicked()
{
// dla kazdej z nog
	for (int i = 0; i < lib::smb::LEG_CLAMP_NUMBER; i++) {
		// wybierz wariant
...
void wgt_sbench_command::on_pushButton_fl_all_down_clicked()
{
// dla kazdej z nog
	for (int i = 0; i < lib::smb::LEG_CLAMP_NUMBER; i++) {
		// wybierz wariant
...
void wgt_sbench_command::on_pushButton_m_execute_clicked()
{
...
void wgt_sbench_command::on_pushButton_ml_rigth_clicked()
{
	get_desired_position();
	robot->desired_pos[0] += doubleSpinBox_m_relative_Vector[0]->value();
	move_it();
...
void wgt_sbench_command::on_pushButton_ms_left_clicked()
{
	get_desired_position();
...
void wgt_sbench_command::on_pushButton_ms_rigth_clicked()
{
	get_desired_position();
	robot->desired_pos[1] += doubleSpinBox_m_relative_Vector[1]->value();
	move_it();
...
void wgt_sbench_command::on_pushButton_stop_clicked()
{
	interface.ui_msg->message("on_pushButton_stop_clicked");
	robot->execute_stop_motor();
}

void wgt_sbench_command::on_radioButton_m_motor_toggled()
{
	if (ui.radioButton_m_motor->isChecked()) {
...
void wgt_sbench_command::on_radioButton_m_joint_toggled()
{
...
void wgt_sbench_command::on_radioButton_m_ext_toggled()
{
