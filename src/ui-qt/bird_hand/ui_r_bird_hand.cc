...
int UiRobot::manage_interface()
{
	...
	{
		case -1:
			mw->enable_menu_item(false, 1, mw->getMenuBar()->menuBirdhand);
			/* TR
			 ApModifyItemState(&robot_menu, AB_ITEM_DIM, ABN_mm_bird_hand, NULL);
			 */
			break;
		case 0:
			mw->enable_menu_item(false, 3, mw->getMenuBar()->actionbirdhand_EDP_Unload, mw->getMenuBar()->actionbirdhand_Command, mw->getMenuBar()->actionbirdhand_Configuration);
			mw->enable_menu_item(true, 1, mw->getMenuBar()->menuBirdhand);
			mw->enable_menu_item(true, 1, mw->getMenuBar()->actionbirdhand_EDP_Load);
			/* TR
		...
		case 2:
			...
			if (state.edp.is_synchronised) {
				//mw->enable_menu_item(false, 1, mw->getMenuBar()->menuRobot); //??
				...
				switch (interface.mp.state)
				{
					...
					case common::UI_MP_PERMITED_TO_RUN:
						mw->enable_menu_item(true, 3, mw->getMenuBar()->actionbirdhand_EDP_Unload, mw->getMenuBar()->actionbirdhand_Command, mw->getMenuBar()->actionbirdhand_Configuration);
						mw->enable_menu_item(false, 1, mw->getMenuBar()->actionbirdhand_EDP_Load);
						/* TR
					...
					case common::UI_MP_WAITING_FOR_START_PULSE:
						mw->enable_menu_item(true, 2, mw->getMenuBar()->actionbirdhand_Command, mw->getMenuBar()->actionbirdhand_Configuration);
						mw->enable_menu_item(false, 2, mw->getMenuBar()->actionbirdhand_EDP_Unload, mw->getMenuBar()->actionbirdhand_EDP_Load);
						/* TR
					...
					case common::UI_MP_TASK_PAUSED:
						mw->enable_menu_item(false, 2, mw->getMenuBar()->actionbirdhand_Command, mw->getMenuBar()->actionbirdhand_Configuration);
						/* TR
			...
			{
				mw->enable_menu_item(true, 1, mw->getMenuBar()->actionbirdhand_EDP_Unload);
				mw->enable_menu_item(false, 3, mw->getMenuBar()->actionbirdhand_EDP_Load, mw->getMenuBar()->actionbirdhand_Command, mw->getMenuBar()->actionbirdhand_Configuration);
				/* TR
