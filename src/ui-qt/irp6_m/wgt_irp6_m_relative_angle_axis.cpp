...
//{
//	robot->zero_desired_position(); // zerowanie desired position
//	for (int i = 0; i < aa_number; i++)
...
/*void wgt_irp6_m_relative_angle_axis::on_pushButton_r_clicked(int i)
{
...
void wgt_irp6_m_relative_angle_axis::on_pushButton_l_clicked(int i)
{
	robot->zero_desired_position();
	robot->desired_pos[i] = -doubleSpinBox_des_Vector[i]->value();
	move_it();
