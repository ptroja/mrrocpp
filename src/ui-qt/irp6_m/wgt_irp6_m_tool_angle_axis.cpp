...
int wgt_irp6_m_tool_angle_axis::synchro_depended_widgets_disable(bool _set_disabled)
{
	ui.pushButton_set->setDisabled(_set_disabled);
...
void wgt_irp6_m_tool_angle_axis::synchro_depended_init()
{
	emit synchro_depended_init_signal();
}

void wgt_irp6_m_tool_angle_axis::init_and_copy()
{
	emit init_and_copy_signal();
}

void wgt_irp6_m_tool_angle_axis::init_and_copy_slot()
{
	init();
	copy();
}
...
void wgt_irp6_m_tool_angle_axis::synchro_depended_init_slot()
{
...
// slots
void wgt_irp6_m_tool_angle_axis::on_pushButton_read_clicked()
{
	printf("read\n");
	init();
}
