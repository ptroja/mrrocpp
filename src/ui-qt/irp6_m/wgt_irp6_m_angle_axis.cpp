...
void wgt_irp6_m_angle_axis::my_open()
{
	wgt_base::my_open();
	init_and_copy_slot();
}
...
void wgt_irp6_m_angle_axis::on_pushButton_7l_clicked()
{
	get_desired_position();
...
void wgt_irp6_m_angle_axis::on_pushButton_8l_clicked()
{
	get_desired_position();
	robot.desired_pos[6] -= ui.doubleSpinBox_step->value();
	move_it();
...
void wgt_irp6_m_angle_axis::on_pushButton_7r_clicked()
{
	get_desired_position();
	robot.desired_pos[6] += ui.doubleSpinBox_step->value();
	move_it();
...
void wgt_irp6_m_angle_axis::on_pushButton_8r_clicked()
{
	get_desired_position();
