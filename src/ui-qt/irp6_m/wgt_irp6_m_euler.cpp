...
wgt_irp6_m_euler::wgt_irp6_m_euler(QString _widget_label, mrrocpp::ui::common::Interface& _interface, mrrocpp::ui::irp6_m::UiRobot& _robot, QWidget *parent) :
	wgt_base(_widget_label, _interface, parent), robot(_robot)
{
	...
	if (robot.robot_name == lib::irp6ot_m::ROBOT_NAME) {
		doubleSpinBox_cur_Vector.append(ui.doubleSpinBox_cur_p8);
		doubleSpinBox_des_Vector.append(ui.doubleSpinBox_des_p8);
	}

	if (robot.robot_name == lib::irp6p_m::ROBOT_NAME) {
		ui.label_3->hide();
		ui.doubleSpinBox_cur_p8->hide();
		ui.doubleSpinBox_des_p8->hide();
		ui.pushButton_8l->hide();
		ui.pushButton_8r->hide();
	}
...
int wgt_irp6_m_euler::synchro_depended_widgets_disable(bool _set_disabled)
{
...
void wgt_irp6_m_euler::synchro_depended_init()
{
	emit synchro_depended_init_signal();
}

void wgt_irp6_m_euler::init_and_copy()
{
	emit init_and_copy_signal();
}

void wgt_irp6_m_euler::init_and_copy_slot()
{
	init();
	copy();
}

void wgt_irp6_m_euler::synchro_depended_init_slot()
{
...
// slots
void wgt_irp6_m_euler::on_pushButton_read_clicked()
{
	printf("read\n");
	init();
}

int wgt_irp6_m_euler::init()
{
...
void wgt_irp6_m_euler::on_pushButton_import_clicked()
{
...
void wgt_irp6_m_euler::on_pushButton_export_clicked()
{
...
void wgt_irp6_m_euler::on_pushButton_copy_clicked()
{
	copy();
}

int wgt_irp6_m_euler::copy()
{
...
void wgt_irp6_m_euler::on_pushButton_execute_clicked()
{
	get_desired_position();
	move_it();
}

void wgt_irp6_m_euler::on_pushButton_1l_clicked()
{
	get_desired_position();
...
void wgt_irp6_m_euler::on_pushButton_2l_clicked()
{
	get_desired_position();
...
void wgt_irp6_m_euler::on_pushButton_3l_clicked()
{
	get_desired_position();
...
void wgt_irp6_m_euler::on_pushButton_4l_clicked()
{
	get_desired_position();
...
void wgt_irp6_m_euler::on_pushButton_5l_clicked()
{
	get_desired_position();
...
void wgt_irp6_m_euler::on_pushButton_6l_clicked()
{
	get_desired_position();
...
void wgt_irp6_m_euler::on_pushButton_7l_clicked()
{
	get_desired_position();
...
void wgt_irp6_m_euler::on_pushButton_8l_clicked()
{
	get_desired_position();
	robot.desired_pos[7] -= ui.doubleSpinBox_step->value();
	move_it();
}

void wgt_irp6_m_euler::on_pushButton_1r_clicked()
{
	get_desired_position();
	robot.desired_pos[0] += ui.doubleSpinBox_step->value();
	move_it();
...
void wgt_irp6_m_euler::on_pushButton_2r_clicked()
{
	get_desired_position();
	robot.desired_pos[1] += ui.doubleSpinBox_step->value();
	move_it();
...
void wgt_irp6_m_euler::on_pushButton_3r_clicked()
{
	get_desired_position();
	robot.desired_pos[2] += ui.doubleSpinBox_step->value();
	move_it();
...
void wgt_irp6_m_euler::on_pushButton_4r_clicked()
{
	get_desired_position();
	robot.desired_pos[3] += ui.doubleSpinBox_step->value();
	move_it();
...
void wgt_irp6_m_euler::on_pushButton_5r_clicked()
{
	get_desired_position();
	robot.desired_pos[4] += ui.doubleSpinBox_step->value();
	move_it();
...
void wgt_irp6_m_euler::on_pushButton_6r_clicked()
{
	get_desired_position();
	robot.desired_pos[5] += ui.doubleSpinBox_step->value();
	move_it();
...
void wgt_irp6_m_euler::on_pushButton_7r_clicked()
{
	get_desired_position();
	robot.desired_pos[6] += ui.doubleSpinBox_step->value();
	move_it();
...
void wgt_irp6_m_euler::on_pushButton_8r_clicked()
{
	get_desired_position();
	robot.desired_pos[7] += ui.doubleSpinBox_step->value();
	move_it();
...
int wgt_irp6_m_euler::get_desired_position()
{
