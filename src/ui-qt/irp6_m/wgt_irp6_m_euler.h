...
class wgt_irp6_m_euler : public wgt_base
{
Q_OBJECT

public:
			wgt_irp6_m_euler(QString _widget_label, mrrocpp::ui::common::Interface& _interface, mrrocpp::ui::irp6_m::UiRobot& _robot, QWidget *parent =
					0);
	~wgt_irp6_m_euler();
