...
//! \sa GetReferenceOfTheNewPositionVectorObject(void) const
//! \sa GetReferenceOfTheNewPositionVectorData(void) const
//  ----------------------------------------------------------
...
//  ---------------------- Doxygen info ----------------------
//! \fn inline RMLDoubleVector* GetReferenceOfTheNewPositionVectorObject(void) const
//! 
//! \brief
//! Returns a pointer to an \c RMLDoubleVector object that contains the 
//! new selection vector \f$ \vec{P}_{i+1} \f$
//! 
//! \details
...
//! \sa RMLDoubleVector
//  ----------------------------------------------------------
    inline RMLDoubleVector* GetReferenceOfTheNewPositionVectorObject(void) const
    {
        return(this->NewPositionVector);
    }


//  ---------------------- Doxygen info ----------------------
//! \fn inline double* GetReferenceOfTheNewPositionVectorData(void) const
//! 
//! \brief
...
//! the content of this output vector can be directly accessed and any
...
//! \sa RMLDoubleVector
//  ----------------------------------------------------------
    inline double* GetReferenceOfTheNewPositionVectorData(void) const
    {
        return((double*)this->NewPositionVector->VecData);
    }
...
//! \sa GetReferenceOfTheNewVelocityVectorObject(void) const
//! \sa GetReferenceOfTheNewVelocityVectorData(void) const
//  ----------------------------------------------------------
...
//  ---------------------- Doxygen info ----------------------
//! \fn inline RMLDoubleVector* GetReferenceOfTheNewVelocityVectorObject(void) const
//! 
//! \brief
//! Returns a pointer to an \c RMLDoubleVector object that contains the 
//! new selection vector \f$ \vec{V}_{i+1} \f$
//! 
//! \details
//! This method may be useful to directly access the RMLDoubleVector object.
//! 
...
//! \sa RMLDoubleVector
//  ----------------------------------------------------------
    inline RMLDoubleVector* GetReferenceOfTheNewVelocityVectorObject(void) const
    {
...
//  ---------------------- Doxygen info ----------------------
//! \fn inline double* GetReferenceOfTheNewVelocityVectorData(void) const
//! 
//! \brief
//! Returns a pointer to an array of \c double values that contain the 
//! new selection vector \f$ \vec{V}_{i+1} \f$
...
//! \sa RMLDoubleVector
//  ----------------------------------------------------------
    inline double* GetReferenceOfTheNewVelocityVectorData(void) const
    {
        return((double*)this->NewVelocityVector->VecData);
    }
...
//! \sa GetReferenceOfTheNewAccelerationVectorObject(void) const
//! \sa GetReferenceOfTheNewAccelerationVectorData(void) const
//  ----------------------------------------------------------
...
//  ---------------------- Doxygen info ----------------------
//! \fn inline RMLDoubleVector* GetReferenceOfTheNewAccelerationVectorObject(void) const
//! 
//! \brief
//! Returns a pointer to an \c RMLDoubleVector object that contains the 
//! new selection vector \f$ \vec{A}_{i+1} \f$
//! 
//! \details
//! This method may be useful to directly access the RMLDoubleVector object.
//! 
...
//! \sa RMLDoubleVector
//  ----------------------------------------------------------
    inline RMLDoubleVector* GetReferenceOfTheNewAccelerationVectorObject(void) const
    {
        return(this->NewAccelerationVector);
    }


//  ---------------------- Doxygen info ----------------------
//! \fn inline double* GetReferenceOfTheNewAccelerationVectorData(void) const
//! 
//! \brief
//! Returns a pointer to an array of \c double values that contain the 
//! new selection vector \f$ \vec{A}_{i+1} \f$
...
//! \sa RMLDoubleVector
//  ----------------------------------------------------------
    inline double* GetReferenceOfTheNewAccelerationVectorData(void) const
    {
        return((double*)this->NewAccelerationVector->VecData);
    }
...
//  ---------------------- Doxygen info ----------------------
//! \fn inline double* GetReferenceOfTheMinimumPositionVectorData(void) const
//! 
//! \brief
//! Returns a \c double pointer to an array of \c double values that
//! contain the minimum positional values during this trajectory
//! 
//! \details
//! The returned value is a pointer to the memory area that contains the 
//! pure content data of an \c RMLDoubleVector object. Using this pointer,,
...
//! additional copy operations will be completely avoided to save CPU time.
//! 
//! \sa GetReferenceOfTheMaximumPositionVectorData(void) const
//! \sa GetPositionalExtrema(double *MinimumPositionVector, double *MaximumPositionVector, const unsigned int &SizeInBytes) const
//! \sa GetPositionalExtrema(RMLDoubleVector *MinimumPositionVector, RMLDoubleVector *MaximumPositionVector) const
//  ----------------------------------------------------------
    inline double* GetReferenceOfTheMinimumPositionVectorData(void) const
    {
        return(this->MinPosExtremaPositionVectorOnly->VecData);
    }


//  ---------------------- Doxygen info ----------------------
//! \fn inline double* GetReferenceOfTheMaximumPositionVectorData(void) const
//! 
//! \brief
//! Returns a \c double pointer to an array of \c double values that
//! contain the maximum positional values during this trajectory
//! 
//! \details
//! The returned value is a pointer to the memory area that contains the 
//! pure content data of an \c RMLDoubleVector object. Using this pointer,,
...
//! additional copy operations will be completely avoided to save CPU time.
//! 
//! \sa GetReferenceOfTheMinimumPositionVectorData(void) const
//! \sa GetPositionalExtrema(double *MinimumPositionVector, double *MaximumPositionVector, const unsigned int &SizeInBytes) const
//! \sa GetPositionalExtrema(RMLDoubleVector *MinimumPositionVector, RMLDoubleVector *MaximumPositionVector) const
//  ----------------------------------------------------------
    inline double* GetReferenceOfTheMaximumPositionVectorData(void) const
    {
        return(this->MaxPosExtremaPositionVectorOnly->VecData);
    }


//  ---------------------- Doxygen info ----------------------
//! \fn inline RMLDoubleVector* GetReferenceOfTheMinimumPositionVectorObject(void) const
//! 
//! \brief
//! Returns a pointer to an \c RMLDoubleVector object that
//! contains the minimum positional values during this trajectory
//! 
//! \details
//! This method may be useful to directly access the RMLDoubleVector object.
//! 
//! \sa GetReferenceOfTheMaximumPositionVectorObject(void) const
//! \sa RMLVector
//! \sa RMLDoubleVector
//  ----------------------------------------------------------
    inline RMLDoubleVector* GetReferenceOfTheMinimumPositionVectorObject(void) const
    {
        return(this->MinPosExtremaPositionVectorOnly);
    }


//  ---------------------- Doxygen info ----------------------
//! \fn inline RMLDoubleVector* GetReferenceOfTheMaximumPositionVectorObject(void) const
//! 
//! \brief
//! Returns a pointer to an \c RMLDoubleVector object that
//! contains the maximum positional values during this trajectory
//! 
//! \details
//! This method may be useful to directly access the RMLDoubleVector object.
//! 
//! \sa GetReferenceOfTheMinimumPositionVectorObject(void) const
//! \sa RMLVector
//! \sa RMLDoubleVector
//  ----------------------------------------------------------
    inline RMLDoubleVector* GetReferenceOfTheMaximumPositionVectorObject(void) const
    {
        return(this->MaxPosExtremaPositionVectorOnly);
    }	


//  ---------------------- Doxygen info ----------------------
//! \fn inline RMLDoubleVector* GetReferenceOfTheMinExtremaTimesVectorObject(void) const
//! 
//! \brief
//! Returns a pointer to an \c RMLDoubleVector object that
//! contains the times, at which the minimum positional values are reached
//! 
//! \details
//! This method may be useful to directly access the RMLDoubleVector object.
//! 
//! \sa GetReferenceOfTheMinExtremaTimesVectorData(void) const
//! \sa RMLVector
//! \sa RMLDoubleVector
//  ----------------------------------------------------------
    inline RMLDoubleVector* GetReferenceOfTheMinExtremaTimesVectorObject(void) const
    {
        return(this->MinExtremaTimesVector);
    }


//  ---------------------- Doxygen info ----------------------
//! \fn inline double* GetReferenceOfTheMinExtremaTimesVectorData(void) const
//! 
//! \brief
//! Returns a \c double pointer to an array of \c double values that
//! contain the times, at which the minimum positional values are reached
//! 
//! \details
//! The returned value is a pointer to the memory area that contains the 
//! pure content data of an \c RMLDoubleVector object. Using this pointer,,
...
//! additional copy operations will be completely avoided to save CPU time.
//! 
//! \sa GetReferenceOfTheMinExtremaTimesVectorObject(void) const
//! \sa GetReferenceOfTheMaxExtremaTimesVectorData(void) const
//  ----------------------------------------------------------
    inline double* GetReferenceOfTheMinExtremaTimesVectorData(void) const
    {
        return(this->MinExtremaTimesVector->VecData);
    }


//  ---------------------- Doxygen info ----------------------
//! \fn inline RMLDoubleVector* GetReferenceOfTheMaxExtremaTimesVectorObject(void) const
//! 
//! \brief
//! Returns a pointer to an \c RMLDoubleVector object that
//! contains the times, at which the maximum positional values are reached
//! 
//! \details
//! This method may be useful to directly access the RMLDoubleVector object.
//! 
...
//! \sa RMLDoubleVector
//  ----------------------------------------------------------
    inline RMLDoubleVector* GetReferenceOfTheMaxExtremaTimesVectorObject(void) const
    {
        return(this->MaxExtremaTimesVector);
    }
    

//  ---------------------- Doxygen info ----------------------
//! \fn inline double* GetReferenceOfTheMaxExtremaTimesVectorData(void) const
//! 
//! \brief
//! Returns a \c double pointer to an array of \c double values that
//! contain the times, at which the maximum positional values are reached
//! 
//! \details
//! The returned value is a pointer to the memory area that contains the 
//! pure content data of an \c RMLDoubleVector object. Using this pointer,,
...
//! additional copy operations will be completely avoided to save CPU time.
//! 
//! \sa GetReferenceOfTheMaxExtremaTimesVectorObject(void) const
//! \sa GetReferenceOfTheMinExtremaTimesVectorData(void) const
//  ----------------------------------------------------------
    inline double* GetReferenceOfTheMaxExtremaTimesVectorData(void) const
    {
        return(this->MaxExtremaTimesVector->VecData);
    }
    

//  ---------------------- Doxygen info ----------------------
//! \fn inline double* GetReferenceOfTheExecutionTimesData(void) const
//! 
//! \brief
//! Returns a pointer to an array of \c double values that contain the 
//! execution times for each degree of freedom, at which the desired
...
//! additional copy operations will be completely avoided to save CPU time.
//! 
//! \sa GetReferenceOfTheExecutionTimesObject(void) const
//! \sa RMLVector
//! \sa RMLDoubleVector
//! \sa RMLOutputParameters::ExecutionTimes
//  ----------------------------------------------------------
    inline double* GetReferenceOfTheExecutionTimesData(void) const
    {
        return( (double*)this->ExecutionTimes->VecData );
    }
...
//  ---------------------- Doxygen info ----------------------
//! \fn inline RMLDoubleVector** GetReferenceOfTheMinPosPositionVectors(void) const
//! 
//! \brief
//! Returns a pointer to an array of \c RMLDoubleVector objects that
//! contains the position vectors of all degrees of freedom at the instant,
//! at which a particular degree of freedom reaches its minimum position
//! value.
//! 
//! \details
//! The returned value is a pointer to the memory area that contains the 
//! pure content data of the array of \c RMLDoubleVector objects. Using
//! this pointer, the content of these output values can be directly 
//! accessed and any additional copy operations will be completely avoided 
//! to save CPU time. This method is used by the library of the On-Line
//! trajectory algorithm to write the contents into this part of the
//! output values.
//! 
//! \sa GetReferenceOfTheMaxPosPositionVectors(void) const
//! \sa GetReferenceOfTheMinPosVelocityVectors(void) const
//! \sa GetReferenceOfTheMinPosAccelerationVectors(void) const
//  ----------------------------------------------------------
    inline RMLDoubleVector** GetReferenceOfTheMinPosPositionVectors(void) const
    {
        return(this->MinPosExtremaPositionVectorArray);
    }
    
    
//  ---------------------- Doxygen info ----------------------
//! \fn inline RMLDoubleVector** GetReferenceOfTheMinPosVelocityVectors(void) const
//! 
//! \brief
//! Returns a pointer to an array of \c RMLDoubleVector objects that
//! contains the velocity vectors of all degrees of freedom at the instant,
//! at which a particular degree of freedom reaches its minimum position
//! value.
//! 
//! \details
...
//! output values.
//! 
//! \sa GetReferenceOfTheMaxPosVelocityVectors(void) const
//! \sa GetReferenceOfTheMinPosPositionVectors(void) const
//! \sa GetReferenceOfTheMinPosAccelerationVectors(void) const
//  ----------------------------------------------------------
    inline RMLDoubleVector** GetReferenceOfTheMinPosVelocityVectors(void) const
    {
        return(this->MinPosExtremaVelocityVectorArray);
    }


//  ---------------------- Doxygen info ----------------------
//! \fn inline RMLDoubleVector** GetReferenceOfTheMinPosAccelerationVectors(void) const
//! 
//! \brief
//! Returns a pointer to an array of \c RMLDoubleVector objects that
//! contains the acceleration vectors of all degrees of freedom at the
//! instant, at which a particular degree of freedom reaches its minimum
//! position value.
//! 
//! \details
//! The returned value is a pointer to the memory area that contains the 
...
//! output values.
//! 
//! \sa GetReferenceOfTheMaxPosAccelerationVectors(void) const
//! \sa GetReferenceOfTheMinPosPositionVectors(void) const
//! \sa GetReferenceOfTheMinPosAccelerationVectors(void) const
//  ----------------------------------------------------------
    inline RMLDoubleVector** GetReferenceOfTheMinPosAccelerationVectors(void) const
    {
        return(this->MinPosExtremaAccelerationVectorArray);
    }


//  ---------------------- Doxygen info ----------------------
//! \fn inline RMLDoubleVector** GetReferenceOfTheMaxPosPositionVectors(void) const
//! 
//! \brief
//! Returns a pointer to an array of \c RMLDoubleVector objects that
//! contains the position vectors of all degrees of freedom at the instant,
//! at which a particular degree of freedom reaches its maximum position
//! value.
//! 
//! \details
//! The returned value is a pointer to the memory area that contains the 
...
//! \sa GetReferenceOfTheMaxPosAccelerationVectors(void) const
//  ----------------------------------------------------------
    inline RMLDoubleVector** GetReferenceOfTheMaxPosPositionVectors(void) const
    {
        return(this->MaxPosExtremaPositionVectorArray);
    }
    
    
//  ---------------------- Doxygen info ----------------------
//! \fn inline RMLDoubleVector** GetReferenceOfTheMaxPosVelocityVectors(void) const
//! 
//! \brief
//! Returns a pointer to an array of \c RMLDoubleVector objects that
//! contains the velocity vectors of all degrees of freedom at the instant,
...
//! \sa GetReferenceOfTheMaxPosAccelerationVectors(void) const
//  ----------------------------------------------------------
    inline RMLDoubleVector** GetReferenceOfTheMaxPosVelocityVectors(void) const
    {
        return(this->MaxPosExtremaVelocityVectorArray);
    }


//  ---------------------- Doxygen info ----------------------
//! \fn inline RMLDoubleVector** GetReferenceOfTheMaxPosAccelerationVectors(void) const
//! 
//! \brief
//! Returns a pointer to an array of \c RMLDoubleVector objects that
//! contains the acceleration vectors of all degrees of freedom at the
//! instant, at which a particular degree of freedom reaches its maximum
//! position value.
//! 
//! \details
//! The returned value is a pointer to the memory area that contains the 
...
//! \sa GetReferenceOfTheMaxPosAccelerationVectors(void) const
//  ----------------------------------------------------------
    inline RMLDoubleVector** GetReferenceOfTheMaxPosAccelerationVectors(void) const
    {
        return(this->MaxPosExtremaAccelerationVectorArray);
    }
...
//  ---------------------- Doxygen info ----------------------
//! \fn inline bool *GetReferenceOfNewComputationFlag(void) const
//! 
//! \brief
//! Returns of \c bool pointer to the value of 
//! RMLOutputParameters::ANewCalculationWasPerformed
//! 
//! \returns
//! \c bool pointer to RMLOutputParameters::ANewCalculationWasPerformed.
//  ----------------------------------------------------------	
    inline bool *GetReferenceOfNewComputationFlag(void) const
    {
        return((bool*)&(this->ANewCalculationWasPerformed));
    }


//  ---------------------- Doxygen info ----------------------
//! \fn inline bool* GetReferenceOfThePhaseSynchronizationFlag(void) const
//! 
//! \brief
//! Returns a point top the \c bool flag that indicates whether the
//! currently calculated trajectory is phase-synchronized or only
//! time-synchronized
//! 
//! \return 
//! A pointer to the phase-synchronization flag
//  ----------------------------------------------------------
    inline bool* GetReferenceOfThePhaseSynchronizationFlag(void) const
    {
        return((bool*)&(this->TrajectoryIsPhaseSynchronized));
    }
...
//  ---------------------- Doxygen info ----------------------
//! \fn inline double* GetReferenceOfTheSynchronizationTimeValue(void) const
//! 
//! \brief
//! Returns a pointer to the variable of the synchronization time
//! 
//! \return
//! A pointer to the variable of the synchronization time
//!
//! \sa RMLOutputParameters::SynchronizationTime
//  ----------------------------------------------------------										
    inline double* GetReferenceOfTheSynchronizationTimeValue(void) const
    {
        return((double*)(&(this->SynchronizationTime)));
    }
...
//  ---------------------- Doxygen info ----------------------
//! \fn inline unsigned int GetReferenceOfTheDOFWithTheGreatestExecutionTime(void) const
//! 
//! \brief
//! Returns a pointer to the \c unsigned \c int value of the index of
//! the degree of freedom with the greatest trajectory execution time
//! 
//! \sa RMLOutputParameters::GetGreatestExecutionTime()
//! \sa RMLOutputParameters::GetDOFWithTheGreatestExecutionTime()
//  ----------------------------------------------------------
    inline unsigned int *GetReferenceOfTheDOFWithTheGreatestExecutionTime(void) const
    {
        return((unsigned int*)&(this->DOFWithTheGreatestExecutionTime));
    }
...
//! \sa GetReferenceOfTheExecutionTimesObject(void) const
//! \sa GetReferenceOfTheExecutionTimesData(void) const
//! \sa RMLOutputParameters::ExecutionTimes
//  ----------------------------------------------------------
...
//  ---------------------- Doxygen info ----------------------
//! \fn inline RMLDoubleVector* GetReferenceOfTheExecutionTimesObject(void) const
//! 
//! \brief
//! Returns a pointer to an \c RMLDoubleVector object that contains the 
//! execution times for each degree of freedom, at which the desired
...
//! \sa RMLOutputParameters::ExecutionTimes
//  ----------------------------------------------------------
    inline RMLDoubleVector* GetReferenceOfTheExecutionTimesObject(void) const
    {
...
//! 
//! \brief
//! Prints the ne state of motion of the output parameters to *FileHandler
//! 
//! \param FileHandler
...
//!  - GetReferenceOfNewComputationFlag(void) const\n\n
//  ----------------------------------------------------------
...
//!  - GetReferenceOfThePhaseSynchronizationFlag(void) const\n\n
//  ----------------------------------------------------------	
...
//!  - GetReferenceOfTheDOFWithTheGreatestExecutionTime(void) const\n\n 
//  ----------------------------------------------------------	
...
//!  - GetReferenceOfTheSynchronizationTimeValue(void) const\n\n
//  ----------------------------------------------------------						
...
//!  - GetReferenceOfTheNewPositionVectorObject(void) const\n\n
//!  - GetReferenceOfTheNewPositionVectorData(void) const\n\n
//  ----------------------------------------------------------
...
//!  - GetReferenceOfTheNewVelocityVectorObject(void) const\n\n
//!  - GetReferenceOfTheNewVelocityVectorData(void) const\n\n
//  ----------------------------------------------------------	
...
//!  - GetReferenceOfTheNewAccelerationVectorObject(void) const\n\n
//!  - GetReferenceOfTheNewAccelerationVectorData(void) const\n\n
//  ----------------------------------------------------------	
...
//! \details
//! This attribute can be accessed directly or by using one of the following methods:\n\n
//!  - GetReferenceOfTheMinExtremaTimesVectorObject(void) const\n\n
//!  - GetReferenceOfTheMinExtremaTimesVectorData(void) const\n\n 
...
//! \details
//! This attribute can be accessed directly or by using one of the following methods:\n\n
//!  - GetReferenceOfTheMaxExtremaTimesVectorObject(void) const\n\n
//!  - GetReferenceOfTheMaxExtremaTimesVectorData(void) const\n\n 
...
//!  - GetReferenceOfTheMinimumPositionVectorData(void) const\n\n
//!  - GetReferenceOfTheMinimumPositionVectorObject(void) const\n\n
//  ----------------------------------------------------------			
...
//!  - GetPositionalExtrema(RMLDoubleVector *MinimumPositionVector, RMLDoubleVector *MaximumPositionVector) const\n\n
//!  - GetPositionalExtrema(double *MinimumPositionVector, double *MaximumPositionVector, const unsigned int &SizeInBytes) const\n\n
//!  - GetReferenceOfTheMaximumPositionVectorData(void) const\n\n
//!  - GetReferenceOfTheMaximumPositionVectorObject(void) const\n\n
//  ----------------------------------------------------------
...
//!  - GetReferenceOfTheExecutionTimesObject(void) const\n\n 
//!  - GetReferenceOfTheExecutionTimesData(void) const\n\n
//  ----------------------------------------------------------
...
//!  - GetReferenceOfTheMinPosPositionVectors(void) const\n\n
//  ----------------------------------------------------------
...
//!  - GetMotionStateAtMinPosForOneDOF(const unsigned int &DOF, RMLDoubleVector *PositionVector, RMLDoubleVector *VelocityVector, RMLDoubleVector *AccelerationVector) const\n\n
//!  - GetMotionStateAtMinPosForOneDOF(const unsigned int &DOF, double *PositionVector, double *VelocityVector, double *AccelerationVector, const unsigned int &SizeInBytes) const\n\n
//!  - GetReferenceOfTheMinPosVelocityVectors(void) const\n\n
//  ----------------------------------------------------------	
...
//!  - GetMotionStateAtMinPosForOneDOF(const unsigned int &DOF, RMLDoubleVector *PositionVector, RMLDoubleVector *VelocityVector, RMLDoubleVector *AccelerationVector) const\n\n
//!  - GetMotionStateAtMinPosForOneDOF(const unsigned int &DOF, double *PositionVector, double *VelocityVector, double *AccelerationVector, const unsigned int &SizeInBytes) const\n\n
//!  - GetReferenceOfTheMinPosAccelerationVectors(void) const\n\n
//  ----------------------------------------------------------	
...
//!  - GetReferenceOfTheMaxPosPositionVectors(void) const\n\n
//  ----------------------------------------------------------
...
//!  - GetMotionStateAtMaxPosForOneDOF(const unsigned int &DOF, RMLDoubleVector *PositionVector, RMLDoubleVector *VelocityVector, RMLDoubleVector *AccelerationVector) const\n\n
//!  - GetMotionStateAtMaxPosForOneDOF(const unsigned int &DOF, double *PositionVector, double *VelocityVector, double *AccelerationVector, const unsigned int &SizeInBytes) const\n\n
//!  - GetReferenceOfTheMaxPosVelocityVectors(void) const\n\n
//  ----------------------------------------------------------	
...
//!  - GetMotionStateAtMaxPosForOneDOF(const unsigned int &DOF, RMLDoubleVector *PositionVector, RMLDoubleVector *VelocityVector, RMLDoubleVector *AccelerationVector) const\n\n 
//!  - GetMotionStateAtMaxPosForOneDOF(const unsigned int &DOF, double *PositionVector, double *VelocityVector, double *AccelerationVector, const unsigned int &SizeInBytes) const\n\n
//!  - GetReferenceOfTheMaxPosAccelerationVectors(void) const\n\n
//  ----------------------------------------------------------	
