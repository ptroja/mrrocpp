...
//  ----------------------------------------------------------
    RMLPositionInputParameters(const RMLPositionInputParameters &IP) : RMLInputParameters(IP)
    {
        ...
        *(this->MaxVelocityVector)					=	*(IP.GetReferenceOfTheMaxVelocityVectorObject())				;
        *(this->TargetPositionVector)				=	*(IP.GetReferenceOfTheTargetPositionVectorObject())				;
        *(this->AlternativeTargetVelocityVector)	=	*(IP.GetReferenceOfTheAlternativeTargetVelocityVectorObject())	;
    }
...
//! \sa GetReferenceOfTheMaxVelocityVectorObject(void)  const
//! \sa GetReferenceOfTheMaxVelocityVectorData(void)  const	
//  ----------------------------------------------------------
...
//  ---------------------- Doxygen info ----------------------
//! \fn inline RMLDoubleVector* GetReferenceOfTheMaxVelocityVectorObject(void) const
//! 
//! \brief
//! Returns a pointer to an \c RMLDoubleVector object that contains the 
//! maximum velocity vector \f$ \vec{V}_{i}^{\,max} \f$
//! 
//! \details
...
//! \sa RMLDoubleVector
//  ----------------------------------------------------------
    inline RMLDoubleVector* GetReferenceOfTheMaxVelocityVectorObject(void) const
    {
        return(this->MaxVelocityVector);
    }


//  ---------------------- Doxygen info ----------------------
//! \fn inline double* GetReferenceOfTheMaxVelocityVectorData(void) const
//! 
//! \brief
...
//! \sa RMLDoubleVector
//  ----------------------------------------------------------
    inline double* GetReferenceOfTheMaxVelocityVectorData(void) const
    {
        return((double*)this->MaxVelocityVector->VecData);
    }
...
//! \sa GetReferenceOfTheTargetPositionVectorObject(void)  const
//! \sa GetReferenceOfTheTargetPositionVectorData(void)  const	
//  ----------------------------------------------------------
...
//  ---------------------- Doxygen info ----------------------
//! \fn inline RMLDoubleVector* GetReferenceOfTheTargetPositionVectorObject(void) const
//! 
//! \brief
//! Returns a pointer to an \c RMLDoubleVector object that contains the 
//! target position vector \f$ \vec{P}_{i}^{\,trgt} \f$
//! 
//! \details
//! This method may be useful to directly access the RMLDoubleVector object.
//! 
...
//! \sa RMLDoubleVector
//  ----------------------------------------------------------
    inline RMLDoubleVector* GetReferenceOfTheTargetPositionVectorObject(void) const
    {
        return(this->TargetPositionVector);
    }


//  ---------------------- Doxygen info ----------------------
//! \fn inline double* GetReferenceOfTheTargetPositionVectorData(void) const
//! 
//! \brief
//! Returns a pointer to an array of \c double values that contain the 
//! target position vector \f$ \vec{P}_{i}^{\,trgt} \f$
...
//! \sa RMLDoubleVector
//  ----------------------------------------------------------
    inline double* GetReferenceOfTheTargetPositionVectorData(void) const
    {
        return((double*)this->TargetPositionVector->VecData);
    }
...
//! \sa GetReferenceOfTheAlternativeTargetVelocityVectorObject(void)  const
//! \sa GetReferenceOfTheAlternativeTargetVelocityVectorData(void)  const	
//  ----------------------------------------------------------
...
//  ---------------------- Doxygen info ----------------------
//! \fn inline RMLDoubleVector* GetReferenceOfTheAlternativeTargetVelocityVectorObject(void) const
//! 
//! \brief
//! Returns a pointer to an \c RMLDoubleVector object that contains the 
//! alternative target velocity vector \f$ \vec{V}_{i}^{\,\underline{trgt}} \f$
//! 
//! \details
//! This method may be useful to directly access the RMLDoubleVector object.
//! 
...
//! \sa RMLDoubleVector
//  ----------------------------------------------------------
    inline RMLDoubleVector* GetReferenceOfTheAlternativeTargetVelocityVectorObject(void) const
    {
        return(this->AlternativeTargetVelocityVector);
    }


//  ---------------------- Doxygen info ----------------------
//! \fn inline double* GetReferenceOfTheAlternativeTargetVelocityVectorData(void) const
//! 
//! \brief
//! Returns a pointer to an array of \c double values that contain the 
//! alternative target velocity vector \f$ \vec{V}_{i}^{\,\underline{trgt}} \f$
...
//! \sa RMLDoubleVector
//  ----------------------------------------------------------
    inline double* GetReferenceOfTheAlternativeTargetVelocityVectorData(void) const
    {
        return((double*)this->AlternativeTargetVelocityVector->VecData);
    }
...
//! motion constraints, that is, the maximum values for velocity, 
//! acceleration, and jerk, have to be positive, and the target velocity
...
//  ----------------------------------------------------------
    bool CheckForValidity(void) const
    {
        ...
        for (i = 0; i < this->NumberOfDOFs; i++)
        {
            ...
            {
                if (	((this->MaxVelocityVector->GetReference		())[i]	<=	0.0)
                    ||	((this->MaxAccelerationVector->GetReference	())[i]	<=	0.0)
#ifdef RMLTYPEIV 
					||	((this->MaxJerkVector->GetReference			())[i]	<=	0.0)
#endif
                    ||	(	fabs((this->TargetVelocityVector->GetReference	())[i])
...
#ifdef RMLTYPEIV 
                    &&	((this->MaxVelocityVector->VecData)[i]	>=	(this->MaxJerkVector->VecData)					[i]	)
#endif
                ...
                else
                {
                    ...
                    {
#ifdef RMLTYPEIV 
                        if (	((this->MaxJerkVector->VecData)[i]	>=	fabs((this->CurrentPositionVector->VecData)		[i]))
                            &&	((this->MaxJerkVector->VecData)[i]	>=	fabs((this->TargetPositionVector->VecData)		[i]))
...
//!  - GetReferenceOfTheMaxVelocityVectorObject(void) const\n\n
//!  - GetReferenceOfTheMaxVelocityVectorData(void) const\n\n
//  ----------------------------------------------------------
...
//!  - GetReferenceOfTheTargetPositionVectorObject(void) const\n\n
//!  - GetReferenceOfTheTargetPositionVectorData(void) const\n\n
//  ----------------------------------------------------------
...
//!  - GetReferenceOfTheAlternativeTargetVelocityVectorObject(void) const\n\n
//!  - GetReferenceOfTheAlternativeTargetVelocityVectorData(void) const\n\n       
//! 
//! \note
