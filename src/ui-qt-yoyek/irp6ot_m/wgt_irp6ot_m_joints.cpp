...
wgt_irp6ot_m_joints::wgt_irp6ot_m_joints(mrrocpp::ui::common::Interface& _interface, mrrocpp::ui::irp6ot_m::UiRobot& _robot, QWidget *parent) :
	wgt_base("irp6ot_m joints moves", _interface, parent), robot(_robot)
{
	ui.setupUi(this);
}

wgt_irp6ot_m_joints::~wgt_irp6ot_m_joints()
{
...
void wgt_irp6ot_m_joints::on_pushButton_import_clicked()
{
...
void wgt_irp6ot_m_joints::on_pushButton_export_clicked()
{

	std::stringstream buffer(std::stringstream::in | std::stringstream::out);

	buffer << "edp_irp6ot_m INCREMENTAL POSITION\n " << ui.doubleSpinBox_des_p1->value() << " "
...
void wgt_irp6ot_m_joints::on_pushButton_copy_clicked()
{
	copy();
}

int wgt_irp6ot_m_joints::copy()
{
...
void wgt_irp6ot_m_joints::on_pushButton_execute_clicked()
{
	get_desired_position();
	move_it();
}

void wgt_irp6ot_m_joints::on_pushButton_1l_clicked()
{
	get_desired_position();
...
void wgt_irp6ot_m_joints::on_pushButton_2l_clicked()
{
	get_desired_position();
...
void wgt_irp6ot_m_joints::on_pushButton_3l_clicked()
{
	get_desired_position();
...
void wgt_irp6ot_m_joints::on_pushButton_4l_clicked()
{
	get_desired_position();
...
void wgt_irp6ot_m_joints::on_pushButton_5l_clicked()
{
	get_desired_position();
...
void wgt_irp6ot_m_joints::on_pushButton_6l_clicked()
{
	get_desired_position();
...
void wgt_irp6ot_m_joints::on_pushButton_7l_clicked()
{
	get_desired_position();
...
void wgt_irp6ot_m_joints::on_pushButton_1r_clicked()
{
	get_desired_position();
	robot.desired_pos[0] += ui.doubleSpinBox_step->value();
	move_it();
...
void wgt_irp6ot_m_joints::on_pushButton_2r_clicked()
{
	get_desired_position();
	robot.desired_pos[1] += ui.doubleSpinBox_step->value();
	move_it();
...
void wgt_irp6ot_m_joints::on_pushButton_3r_clicked()
{
	get_desired_position();
	robot.desired_pos[2] += ui.doubleSpinBox_step->value();
	move_it();
...
void wgt_irp6ot_m_joints::on_pushButton_4r_clicked()
{
	get_desired_position();
	robot.desired_pos[3] += ui.doubleSpinBox_step->value();
	move_it();
...
void wgt_irp6ot_m_joints::on_pushButton_5r_clicked()
{
	get_desired_position();
	robot.desired_pos[4] += ui.doubleSpinBox_step->value();
	move_it();
...
void wgt_irp6ot_m_joints::on_pushButton_6r_clicked()
{
	get_desired_position();
	robot.desired_pos[5] += ui.doubleSpinBox_step->value();
	move_it();
...
void wgt_irp6ot_m_joints::on_pushButton_7r_clicked()
{
	get_desired_position();
	robot.desired_pos[6] += ui.doubleSpinBox_step->value();
	move_it();
...
int wgt_irp6ot_m_joints::get_desired_position()
{
...
int wgt_irp6ot_m_joints::move_it()
{
	...
	try {
		...
		if (robot.state.edp.pid != -1) {
			...
			//robot.ui_ecp_robot->interface.irp6ot_m->ui_ecp_robot->move_joints(robot.desired_pos);
