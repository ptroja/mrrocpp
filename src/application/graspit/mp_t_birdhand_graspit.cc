...
void graspit::main_task_algorithm(void)
{
	...
	set_next_ecps_state((int) ecp_mp::task::ECP_GEN_BIRD_HAND, (int) 5, tmp_string, sizeof(mp_ecp_bird_hand_command), 1, gripper_name.c_str());
	...
	set_next_ecps_state((int) ecp_mp::task::ECP_GEN_IRP6, (int) 5, "", 0, 1, manipulator_name.c_str());
