...
for(int k=0; k<6; k++)
{
	...
	set_next_ecps_state ((int) ecp_mp::task::ECP_GEN_FESTIVAL, 0, "oglo~dam kolory na s~ciance", 0, 1, lib::ROBOT_FESTIVAL.c_str());
...
set_next_ecps_state ((int) ecp_mp::task::ECP_GEN_FESTIVAL, 0, "mys~le~", 0, 1, lib::ROBOT_FESTIVAL.c_str());
...
set_next_ecps_state ((int) ecp_mp::task::ECP_GEN_FESTIVAL, 0, "juZ ukl/adam", 0, 1, lib::ROBOT_FESTIVAL.c_str());
...
{
	case common::CL_90:
	set_next_ecps_state ((int) ecp_mp::task::ECP_GEN_SMOOTH, (int) ecp_mp::task::ABSOLUTE, "src/application/rcsc/trj/irp6ot_sm_fturn_ap_cl_90_phase_1.trj", 0, 1, lib::ROBOT_IRP6OT_M.c_str());
	set_next_ecps_state ((int) ecp_mp::task::ECP_GEN_SMOOTH, (int) ecp_mp::task::ABSOLUTE, "src/application/rcsc/trj/irp6p_sm_fturn_ap_cl_90_phase_1.trj", 0,1, lib::ROBOT_IRP6P_M.c_str());
	break;
	case common::CL_0:
	set_next_ecps_state ((int) ecp_mp::task::ECP_GEN_SMOOTH, (int) ecp_mp::task::ABSOLUTE, "src/application/rcsc/trj/irp6ot_sm_fturn_ap_cl_0_phase_1.trj", 0, 1, lib::ROBOT_IRP6OT_M.c_str());
	set_next_ecps_state ((int) ecp_mp::task::ECP_GEN_SMOOTH, (int) ecp_mp::task::ABSOLUTE, "src/application/rcsc/trj/irp6p_sm_fturn_ap_cl_0_phase_1.trj", 0,1, lib::ROBOT_IRP6P_M.c_str());
	break;
	case common::CCL_90:
	set_next_ecps_state ((int) ecp_mp::task::ECP_GEN_SMOOTH, (int) ecp_mp::task::ABSOLUTE, "src/application/rcsc/trj/irp6ot_sm_fturn_ap_ccl_90_phase_1.trj", 0, 1, lib::ROBOT_IRP6OT_M.c_str());
	set_next_ecps_state ((int) ecp_mp::task::ECP_GEN_SMOOTH, (int) ecp_mp::task::ABSOLUTE, "src/application/rcsc/trj/irp6p_sm_fturn_ap_ccl_90_phase_1.trj", 0,1, lib::ROBOT_IRP6P_M.c_str());
	break;
	case common::CL_180:
	set_next_ecps_state ((int) ecp_mp::task::ECP_GEN_SMOOTH, (int) ecp_mp::task::ABSOLUTE, "src/application/rcsc/trj/irp6ot_sm_fturn_ap_cl_180_phase_1.trj", 0,1, lib::ROBOT_IRP6OT_M.c_str());
	set_next_ecps_state ((int) ecp_mp::task::ECP_GEN_SMOOTH, (int) ecp_mp::task::ABSOLUTE, "src/application/rcsc/trj/irp6p_sm_fturn_ap_cl_180_phase_1.trj", 0,1, lib::ROBOT_IRP6P_M.c_str());
	break;
	default:
	break;
}
...
{
	case common::CL_90:
	set_next_ecps_state ((int) ecp_mp::task::ECP_GEN_SMOOTH, (int) ecp_mp::task::ABSOLUTE, "src/application/rcsc/trj/irp6ot_sm_fturn_ap_cl_90_phase_2.trj", 0,1, lib::ROBOT_IRP6OT_M.c_str());
	break;
	case common::CL_0:
	set_next_ecps_state ((int) ecp_mp::task::ECP_GEN_SMOOTH, (int) ecp_mp::task::ABSOLUTE, "src/application/rcsc/trj/irp6ot_sm_fturn_ap_cl_0_phase_2.trj", 0, 1, lib::ROBOT_IRP6OT_M.c_str());
	break;
	case common::CCL_90:
	set_next_ecps_state ((int) ecp_mp::task::ECP_GEN_SMOOTH, (int) ecp_mp::task::ABSOLUTE, "src/application/rcsc/trj/irp6ot_sm_fturn_ap_ccl_90_phase_2.trj", 0, 1, lib::ROBOT_IRP6OT_M.c_str());
	break;
	case common::CL_180:
	set_next_ecps_state ((int) ecp_mp::task::ECP_GEN_SMOOTH, (int) ecp_mp::task::ABSOLUTE, "src/application/rcsc/trj/irp6ot_sm_fturn_ap_cl_180_phase_2.trj", 0, 1, lib::ROBOT_IRP6OT_M.c_str());
	break;
	default:
	break;
}
...
set_next_ecps_state ((int) ecp_mp::task::ECP_GEN_TFF_RUBIK_GRAB, (int) ecp_mp::task::RCSC_RG_FACE_TURN_PHASE_0, "", 0, 1, lib::ROBOT_IRP6P_M.c_str());
// uruchomienie generatora empty_gen
run_extended_empty_gen (false, 1, lib::ROBOT_IRP6P_M.c_str());
// wlaczenie generatora zacisku na kostce w robocie irp6p
set_next_ecps_state ((int) ecp_mp::task::ECP_GEN_TFF_RUBIK_GRAB, (int) ecp_mp::task::RCSC_RG_FROM_OPEARTOR_PHASE_1, "", 0,1, lib::ROBOT_IRP6P_M.c_str());
// uruchomienie generatora empty_gen
run_extended_empty_gen (false, 1, lib::ROBOT_IRP6P_M.c_str());
// wlaczenie generatora zacisku na kostce w robocie irp6p
set_next_ecps_state ((int) ecp_mp::task::ECP_GEN_TFF_RUBIK_GRAB, (int) ecp_mp::task::RCSC_RG_FROM_OPEARTOR_PHASE_2, "", 0,1, lib::ROBOT_IRP6P_M.c_str());
// uruchomienie generatora empty_gen
run_extended_empty_gen (false, 1, lib::ROBOT_IRP6P_M.c_str());
...
{
	case common::CL_90:
	set_next_ecps_state ((int) ecp_mp::task::ECP_GEN_FESTIVAL, 0, "obracam kostke~", 0, 1, lib::ROBOT_FESTIVAL.c_str());
	set_next_ecps_state ((int) ecp_mp::task::ECP_GEN_TFF_RUBIK_FACE_ROTATE, (int) ecp_mp::task::RCSC_CL_90, "", 0, 1, lib::ROBOT_IRP6OT_M.c_str());
	// uruchomienie generatora empty_gen
	run_extended_empty_generator_for_set_of_robots_and_wait_for_task_termination_message_of_another_set_of_robots
	...
	case common::CCL_90:
	set_next_ecps_state ((int) ecp_mp::task::ECP_GEN_FESTIVAL, 0, "obracam kostke~", 0, 1, lib::ROBOT_FESTIVAL.c_str());
	set_next_ecps_state ((int) ecp_mp::task::ECP_GEN_TFF_RUBIK_FACE_ROTATE, (int) ecp_mp::task::RCSC_CCL_90, "", 0, 1, lib::ROBOT_IRP6OT_M.c_str());
	// uruchomienie generatora empty_gen
	run_extended_empty_generator_for_set_of_robots_and_wait_for_task_termination_message_of_another_set_of_robots
	(2, 2, lib::ROBOT_IRP6OT_M.c_str(), lib::ROBOT_FESTIVAL.c_str(), lib::ROBOT_IRP6OT_M.c_str(), lib::ROBOT_FESTIVAL.c_str());
	break;
	case common::CL_180:
	set_next_ecps_state ((int) ecp_mp::task::ECP_GEN_FESTIVAL, 0, "obracam kostke~", 0,1, lib::ROBOT_FESTIVAL.c_str());
	set_next_ecps_state ((int) ecp_mp::task::ECP_GEN_TFF_RUBIK_FACE_ROTATE, (int) ecp_mp::task::RCSC_CL_180, "", 0, 1, lib::ROBOT_IRP6OT_M.c_str());
	// uruchomienie generatora empty_gen
	run_extended_empty_generator_for_set_of_robots_and_wait_for_task_termination_message_of_another_set_of_robots
	(2, 2, lib::ROBOT_IRP6OT_M.c_str(), lib::ROBOT_FESTIVAL.c_str(), lib::ROBOT_IRP6OT_M.c_str(), lib::ROBOT_FESTIVAL.c_str());
	break;
...
set_next_ecps_state ((int) ecp_mp::task::ECP_GEN_SMOOTH, (int) ecp_mp::task::RELATIVE, "src/application/rcsc/trj/gripper_opening2.trj", 0, 1, lib::ROBOT_IRP6OT_M.c_str());

// uruchomienie generatora empty_gen
run_extended_empty_gen (false, 1, lib::ROBOT_IRP6OT_M.c_str());

// odejscie tracka od postumenta
set_next_ecps_state ((int) ecp_mp::task::ECP_GEN_SMOOTH, (int) ecp_mp::task::ABSOLUTE, "src/application/rcsc/trj/irp6ot_sm_fturn_de.trj", 0,1, lib::ROBOT_IRP6OT_M.c_str());
// uruchomienie generatora empty_gen
run_extended_empty_gen (false, 1, lib::ROBOT_IRP6OT_M.c_str());
}
...
set_next_ecps_state ((int) ecp_mp::task::ECP_GEN_FESTIVAL, 0, "przekl/adam kostke~", 0, 1, lib::ROBOT_FESTIVAL.c_str());
...
switch (turn_angle)
{
	...
	set_next_ecps_state ((int) ecp_mp::task::ECP_GEN_SMOOTH, (int) ecp_mp::task::ABSOLUTE, "src/application/rcsc/trj/irp6ot_sm_fchange_ap_cl_90_phase_1.trj", 0, 1, lib::ROBOT_IRP6OT_M.c_str());
	set_next_ecps_state ((int) ecp_mp::task::ECP_GEN_SMOOTH, (int) ecp_mp::task::ABSOLUTE, "src/application/rcsc/trj/irp6p_sm_fchange_ap_cl_90_phase_1.trj", 0,1, lib::ROBOT_IRP6P_M.c_str());
	break;
	case common::CL_0:

	set_next_ecps_state ((int) ecp_mp::task::ECP_GEN_SMOOTH, (int) ecp_mp::task::ABSOLUTE, "src/application/rcsc/trj/irp6ot_sm_fchange_ap_cl_0_phase_1.trj", 0,1, lib::ROBOT_IRP6OT_M.c_str());
	set_next_ecps_state ((int) ecp_mp::task::ECP_GEN_SMOOTH, (int) ecp_mp::task::ABSOLUTE, "src/application/rcsc/trj/irp6p_sm_fchange_ap_cl_0_phase_1.trj", 0,1, lib::ROBOT_IRP6P_M.c_str());
	break;
	case common::CCL_90:

	set_next_ecps_state ((int) ecp_mp::task::ECP_GEN_SMOOTH, (int) ecp_mp::task::ABSOLUTE, "src/application/rcsc/trj/irp6ot_sm_fchange_ap_ccl_90_phase_1.trj", 0,1, lib::ROBOT_IRP6OT_M.c_str());
	set_next_ecps_state ((int) ecp_mp::task::ECP_GEN_SMOOTH, (int) ecp_mp::task::ABSOLUTE, "src/application/rcsc/trj/irp6p_sm_fchange_ap_ccl_90_phase_1.trj", 0, 1, lib::ROBOT_IRP6P_M.c_str());
	break;
	case common::CL_180:

	set_next_ecps_state ((int) ecp_mp::task::ECP_GEN_SMOOTH, (int) ecp_mp::task::ABSOLUTE, "src/application/rcsc/trj/irp6ot_sm_fchange_ap_cl_180_phase_1.trj", 0, 1, lib::ROBOT_IRP6OT_M.c_str());
	set_next_ecps_state ((int) ecp_mp::task::ECP_GEN_SMOOTH, (int) ecp_mp::task::ABSOLUTE, "src/application/rcsc/trj/irp6p_sm_fchange_ap_cl_180_phase_1.trj", 0, 1, lib::ROBOT_IRP6P_M.c_str());
	break;
	default:
	break;
}
...
{
	case common::CL_90:
	set_next_ecps_state ((int) ecp_mp::task::ECP_GEN_SMOOTH, (int) ecp_mp::task::ABSOLUTE, "src/application/rcsc/trj/irp6ot_sm_fchange_ap_cl_90_phase_2.trj", 0,1, lib::ROBOT_IRP6OT_M.c_str());
	break;
	case common::CL_0:
	set_next_ecps_state ((int) ecp_mp::task::ECP_GEN_SMOOTH, (int) ecp_mp::task::ABSOLUTE, "src/application/rcsc/trj/irp6ot_sm_fchange_ap_cl_0_phase_2.trj", 0,1, lib::ROBOT_IRP6OT_M.c_str());
	break;
	case common::CCL_90:
	set_next_ecps_state ((int) ecp_mp::task::ECP_GEN_SMOOTH, (int) ecp_mp::task::ABSOLUTE, "src/application/rcsc/trj/irp6ot_sm_fchange_ap_ccl_90_phase_2.trj", 0,1, lib::ROBOT_IRP6OT_M.c_str());
	break;
	case common::CL_180:
	set_next_ecps_state ((int) ecp_mp::task::ECP_GEN_SMOOTH, (int) ecp_mp::task::ABSOLUTE, "src/application/rcsc/trj/irp6ot_sm_fchange_ap_cl_180_phase_2.trj", 0,1, lib::ROBOT_IRP6OT_M.c_str());
	break;
	default:
	break;
}
...
// wlaczenie generatora zacisku na kostce w robocie irp6ot
set_next_ecps_state ((int) ecp_mp::task::ECP_GEN_TFF_RUBIK_GRAB, (int) ecp_mp::task::RCSC_RG_FCHANGE_PHASE_1, "", 0, 1, lib::ROBOT_IRP6OT_M.c_str());
// uruchomienie generatora empty_gen
run_extended_empty_gen (false, 1, lib::ROBOT_IRP6OT_M.c_str());
// wlaczenie generatora zacisku na kostce w robocie irp6ot
set_next_ecps_state ((int) ecp_mp::task::ECP_GEN_TFF_RUBIK_GRAB, (int) ecp_mp::task::RCSC_RG_FCHANGE_PHASE_2, "", 0,1, lib::ROBOT_IRP6OT_M.c_str());
// uruchomienie generatora empty_gen
run_extended_empty_gen (false, 1, lib::ROBOT_IRP6OT_M.c_str());

// docisniecie chwytaka tracka do kostki

set_next_ecps_state ((int) ecp_mp::task::ECP_GEN_TFF_GRIPPER_APPROACH, (int) 0, "", 0,1, lib::ROBOT_IRP6OT_M.c_str());
// uruchomienie generatora empty_gen
run_extended_empty_gen (false, 1, lib::ROBOT_IRP6OT_M.c_str());
...
// wlaczenie generatora zacisku na kostce w robocie irp6ot
set_next_ecps_state ((int) ecp_mp::task::ECP_GEN_TFF_RUBIK_GRAB, (int) ecp_mp::task::RCSC_RG_FCHANGE_PHASE_3, "", 0,1, lib::ROBOT_IRP6OT_M.c_str());
// uruchomienie generatora empty_gen
run_extended_empty_gen (false, 1, lib::ROBOT_IRP6OT_M.c_str());
...
set_next_ecps_state ((int) ecp_mp::task::ECP_GEN_SMOOTH, (int) ecp_mp::task::RELATIVE, "src/application/rcsc/trj/gripper_opening.trj", 0,1, lib::ROBOT_IRP6P_M.c_str());
// uruchomienie generatora empty_gen
run_extended_empty_gen (false, 1, lib::ROBOT_IRP6P_M.c_str());

// ostateczne zacisniecie tracka na kostce
// wlaczenie generatora zacisku na kostce w robocie irp6ot
set_next_ecps_state ((int) ecp_mp::task::ECP_GEN_TFF_RUBIK_GRAB, (int) ecp_mp::task::RCSC_RG_FCHANGE_PHASE_4, "", 0, 1, lib::ROBOT_IRP6OT_M.c_str());
// uruchomienie generatora empty_gen
run_extended_empty_gen (false, 1, lib::ROBOT_IRP6OT_M.c_str());

// dalsze rozwarcie chwytaka postumenta
set_next_ecps_state ((int) ecp_mp::task::ECP_GEN_SMOOTH, (int) ecp_mp::task::RELATIVE, "src/application/rcsc/trj/gripper_opening2.trj", 0,1, lib::ROBOT_IRP6P_M.c_str());
// uruchomienie generatora empty_gen
run_extended_empty_gen (false, 1, lib::ROBOT_IRP6P_M.c_str());
...
switch (turn_angle)
{
	...
	set_next_ecps_state ((int) ecp_mp::task::ECP_GEN_SMOOTH, (int) ecp_mp::task::ABSOLUTE, "src/application/rcsc/trj/irp6ot_sm_fchange_de_cl_90.trj", 0,1, lib::ROBOT_IRP6OT_M.c_str());
	break;
	case common::CL_0:

	set_next_ecps_state ((int) ecp_mp::task::ECP_GEN_SMOOTH, (int) ecp_mp::task::ABSOLUTE, "src/application/rcsc/trj/irp6ot_sm_fchange_de_cl_0.trj", 0,1, lib::ROBOT_IRP6OT_M.c_str());
	break;
	case common::CCL_90:

	set_next_ecps_state ((int) ecp_mp::task::ECP_GEN_SMOOTH, (int) ecp_mp::task::ABSOLUTE, "src/application/rcsc/trj/irp6ot_sm_fchange_de_ccl_90.trj", 0, 1, lib::ROBOT_IRP6OT_M.c_str());
	break;
	case common::CL_180:

	set_next_ecps_state ((int) ecp_mp::task::ECP_GEN_SMOOTH, (int) ecp_mp::task::ABSOLUTE, "src/application/rcsc/trj/irp6ot_sm_fchange_de_cl_180.trj", 0, 1, lib::ROBOT_IRP6OT_M.c_str());
	break;
	default:
	break;
}
...
set_next_ecps_state ((int) ecp_mp::task::ECP_GEN_FESTIVAL, ecp::festival::generator::generator::POLISH_VOICE, "jestem podatny", 0,1, lib::ROBOT_FESTIVAL.c_str());
...
if ((config.exists("irp6p_compliant")) && ((bool) config.value<int>("irp6p_compliant")))
{
	...
	set_next_ecps_state ((int) ecp_mp::task::ECP_GEN_TFF_NOSE_RUN, (int) 0, "", 0,1, lib::ROBOT_IRP6P_M.c_str());
...
else
{
	...
	set_next_ecps_state ((int) ecp_mp::task::ECP_GEN_TFF_NOSE_RUN, (int) 0, "", 0,1, lib::ROBOT_IRP6OT_M.c_str());
...
set_next_ecps_state ((int) ecp_mp::task::ECP_GEN_SMOOTH, (int) ecp_mp::task::ABSOLUTE, "src/application/rcsc/trj/irp6ot_sm_ap_1.trj", 0,1, lib::ROBOT_IRP6OT_M.c_str());
set_next_ecps_state ((int) ecp_mp::task::ECP_GEN_SMOOTH, (int) ecp_mp::task::ABSOLUTE, "src/application/rcsc/trj/irp6p_sm_ap_1.trj", 0,1, lib::ROBOT_IRP6P_M.c_str());

run_extended_empty_generator_for_set_of_robots_and_wait_for_task_termination_message_of_another_set_of_robots
(3, 2, lib::ROBOT_IRP6OT_M.c_str(), lib::ROBOT_IRP6P_M.c_str(), lib::ROBOT_FESTIVAL.c_str(),
		lib::ROBOT_IRP6OT_M.c_str(), lib::ROBOT_IRP6P_M.c_str());

set_next_ecps_state ((int) ecp_mp::task::ECP_GEN_FESTIVAL, 0, "jestem robotem usl/ugowym", 0, 1, lib::ROBOT_FESTIVAL.c_str());

//zadanie chwytania kostki
set_next_ecps_state ((int) ecp_mp::task::ECP_GEN_SMOOTH, (int) ecp_mp::task::ABSOLUTE, "src/application/rcsc/trj/irp6ot_sm_ap_2.trj", 0,1, lib::ROBOT_IRP6OT_M.c_str());
...
set_next_ecps_state ((int) ecp_mp::task::ECP_GEN_IB_EIH, (int) 1, "", 0,1, lib::ROBOT_IRP6OT_M.c_str());
...
set_next_ecps_state ((int) ecp_mp::task::ECP_GEN_SMOOTH, (int) ecp_mp::task::RELATIVE, "src/application/rcsc/trj/irp6ot_sm_raising_up.trj", 0,1, lib::ROBOT_IRP6OT_M.c_str());
...
set_next_ecps_state ((int) ecp_mp::task::ECP_GEN_SMOOTH, (int) ecp_mp::task::RELATIVE, "src/application/rcsc/trj/irp6ot_sm_gripper_closing.trj", 0,1, lib::ROBOT_IRP6OT_M.c_str());
...
set_next_ecps_state ((int) ecp_mp::task::ECP_GEN_SMOOTH, (int) ecp_mp::task::ABSOLUTE, "src/application/rcsc/trj/irp6ot_sm_ap_3.trj", 0, 1, lib::ROBOT_IRP6OT_M.c_str());
// uruchomienie generatora empty_gen i oczekiwanie na zakonczenie obydwu generatorow ECP
...
{
set_next_ecps_state ((int) ecp_mp::task::ECP_GEN_FESTIVAL, 0, "skon~czyl/em", 0, 1, lib::ROBOT_FESTIVAL.c_str());

set_next_ecps_state ((int) ecp_mp::task::ECP_GEN_SMOOTH, (int) ecp_mp::task::ABSOLUTE, "src/application/rcsc/trj/irp6ot_sm_de_1.trj", 0,1, lib::ROBOT_IRP6OT_M.c_str());

set_next_ecps_state ((int) ecp_mp::task::ECP_GEN_SMOOTH, (int) ecp_mp::task::ABSOLUTE, "src/application/rcsc/trj/irp6p_sm_de_1.trj", 0,1, lib::ROBOT_IRP6P_M.c_str());

run_extended_empty_generator_for_set_of_robots_and_wait_for_task_termination_message_of_another_set_of_robots
(3, 1, lib::ROBOT_IRP6OT_M.c_str(), lib::ROBOT_IRP6P_M.c_str(), lib::ROBOT_FESTIVAL.c_str(), lib::ROBOT_FESTIVAL.c_str());

set_next_ecps_state ((int) ecp_mp::task::ECP_GEN_FESTIVAL, 0, "jade~ pracowac~ do anglii", 0, 1, lib::ROBOT_FESTIVAL.c_str());
