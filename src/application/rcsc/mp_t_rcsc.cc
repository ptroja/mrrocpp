...
void rubik_cube_solver::face_turn_op(common::CUBE_TURN_ANGLE turn_angle)
{
	...
	{
		case common::CL_90:
			set_next_ecps_state(ecp_mp::generator::ECP_GEN_SMOOTH, (int) ecp_mp::task::ABSOLUTE, "src/application/rcsc/trj/irp6ot_sm_fturn_ap_cl_90_phase_1.trj", 0, 1, lib::irp6ot_m::ROBOT_NAME.c_str());
			set_next_ecps_state(ecp_mp::generator::ECP_GEN_SMOOTH, (int) ecp_mp::task::ABSOLUTE, "src/application/rcsc/trj/irp6p_sm_fturn_ap_cl_90_phase_1.trj", 0, 1, lib::irp6p_m::ROBOT_NAME.c_str());
			break;
		case common::CL_0:
			set_next_ecps_state(ecp_mp::generator::ECP_GEN_SMOOTH, (int) ecp_mp::task::ABSOLUTE, "src/application/rcsc/trj/irp6ot_sm_fturn_ap_cl_0_phase_1.trj", 0, 1, lib::irp6ot_m::ROBOT_NAME.c_str());
			set_next_ecps_state(ecp_mp::generator::ECP_GEN_SMOOTH, (int) ecp_mp::task::ABSOLUTE, "src/application/rcsc/trj/irp6p_sm_fturn_ap_cl_0_phase_1.trj", 0, 1, lib::irp6p_m::ROBOT_NAME.c_str());
			break;
		case common::CCL_90:
			set_next_ecps_state(ecp_mp::generator::ECP_GEN_SMOOTH, (int) ecp_mp::task::ABSOLUTE, "src/application/rcsc/trj/irp6ot_sm_fturn_ap_ccl_90_phase_1.trj", 0, 1, lib::irp6ot_m::ROBOT_NAME.c_str());
			set_next_ecps_state(ecp_mp::generator::ECP_GEN_SMOOTH, (int) ecp_mp::task::ABSOLUTE, "src/application/rcsc/trj/irp6p_sm_fturn_ap_ccl_90_phase_1.trj", 0, 1, lib::irp6p_m::ROBOT_NAME.c_str());
			break;
		case common::CL_180:
			set_next_ecps_state(ecp_mp::generator::ECP_GEN_SMOOTH, (int) ecp_mp::task::ABSOLUTE, "src/application/rcsc/trj/irp6ot_sm_fturn_ap_cl_180_phase_1.trj", 0, 1, lib::irp6ot_m::ROBOT_NAME.c_str());
			set_next_ecps_state(ecp_mp::generator::ECP_GEN_SMOOTH, (int) ecp_mp::task::ABSOLUTE, "src/application/rcsc/trj/irp6p_sm_fturn_ap_cl_180_phase_1.trj", 0, 1, lib::irp6p_m::ROBOT_NAME.c_str());
			break;
		default:
			break;
	}
