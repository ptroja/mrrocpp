...
void multiplayer::move_electron_robot(const lib::playerpos_goal_t &goal)
{
	...
	wait_for_task_termination(false, 1, lib::electron::ROBOT_NAME.c_str());
}
...
void multiplayer::main_task_algorithm(void)
{
	...
	//set_next_ecp_state(ecp_mp::generator::ECP_GEN_NEWSMOOTH, 0, "trj/multiplayer/irp6ot_sm_init.trj", 0, 1, lib::irp6ot_m::ROBOT_NAME.c_str());
	set_next_ecp_state(ecp_mp::task::ECP_GEN_FESTIVAL, ecp::festival::generator::generator::POLISH_VOICE, "inicjalizuje~ zadanie", 0, lib::festival::ROBOT_NAME);
	...
	set_next_ecp_state(ecp_mp::sub_task::ECP_ST_GRIPPER_OPENING, 0, NULL, 0, lib::irp6ot_m::ROBOT_NAME);
	// uruchomienie generatora empty_gen i oczekiwanie na zakonczenie generatorow ECP
	...
	set_next_ecp_state(ecp_mp::task::ECP_GEN_FESTIVAL, ecp::festival::generator::generator::POLISH_VOICE, "oczekuje~ na polecenie", 0, lib::festival::ROBOT_NAME);
	// uruchomienie generatora empty_gen i oczekiwanie na zakonczenie generatorow ECP
	...
	do {
		...
		set_next_ecp_state(ecp_mp::task::ECP_GEN_SPEECHRECOGNITION, 0, NULL, 0, lib::speechrecognition::ROBOT_NAME);
		// uruchomienie generatora empty_gen i oczekiwanie na zakonczenie generatorow ECP
		wait_for_task_termination(false, 1, lib::speechrecognition::ROBOT_NAME.c_str());

		const char *qq = robot_m[lib::speechrecognition::ROBOT_NAME]->ecp_reply_package.recognized_command;
		...
		set_next_ecp_state(ecp_mp::task::ECP_GEN_FESTIVAL, ecp::festival::generator::generator::POLISH_VOICE, komunikat, 0, lib::festival::ROBOT_NAME);
		// uruchomienie generatora empty_gen i oczekiwanie na zakonczenie generatorow ECP
		wait_for_task_termination(false, 1, lib::festival::ROBOT_NAME.c_str());
	...
	set_next_playerpos_goal(lib::electron::ROBOT_NAME.c_str(), goal);
	set_next_ecp_state(ecp_mp::task::ECP_GEN_FESTIVAL, ecp::festival::generator::generator::POLISH_VOICE, "jade~ przekazac~ kostke~", 0, lib::festival::ROBOT_NAME);
	//set_next_ecp_state(ecp_mp::generator::ECP_GEN_NEWSMOOTH, 0, "trj/multiplayer/irp6ot_sm_grab.trj", 0, lib::irp6ot_m::ROBOT_NAME);
	// uruchomienie generatora empty_gen i oczekiwanie na zakonczenie generatorow ECP
	wait_for_task_termination(false, 3, lib::electron::ROBOT_NAME.c_str(), lib::festival::ROBOT_NAME.c_str(), lib::irp6ot_m::ROBOT_NAME.c_str());
	...
	set_next_ecp_state(ecp_mp::task::ECP_GEN_FESTIVAL, ecp::festival::generator::generator::POLISH_VOICE, "drugi robot podniesie kostke~", 0, lib::festival::ROBOT_NAME);
	...
	set_next_ecp_state(ecp_mp::task::ECP_GEN_TAKE_FROM_ROVER, 0, "", 0, lib::irp6ot_m::ROBOT_NAME);

	// uruchomienie generatora empty_gen i oczekiwanie na zakonczenie generatorow ECP
	wait_for_task_termination(false, 1, lib::irp6ot_m::ROBOT_NAME.c_str());

	//chwycenie
	set_next_ecp_state(ecp_mp::task::ECP_GEN_GRAB_FROM_ROVER, 0, "", 0, lib::irp6ot_m::ROBOT_NAME);

	// uruchomienie generatora empty_gen i oczekiwanie na zakonczenie generatorow ECP
	wait_for_task_termination(false, 1, lib::irp6ot_m::ROBOT_NAME.c_str());

	//RUCH DO GORY
	//set_next_ecp_state(ecp_mp::generator::ECP_GEN_NEWSMOOTH, 0, "trj/multiplayer/irp6ot_sm_up.trj", 0, lib::irp6ot_m::ROBOT_NAME);
	// uruchomienie generatora empty_gen i oczekiwanie na zakonczenie generatorow ECP
	wait_for_task_termination(false, 1, lib::irp6ot_m::ROBOT_NAME.c_str());
	...
	set_next_ecp_state(ecp_mp::task::ECP_GEN_FESTIVAL, ecp::festival::generator::generator::POLISH_VOICE, "prosze~ odbierz kostke~", 0, lib::festival::ROBOT_NAME);
	// uruchomienie generatora empty_gen i oczekiwanie na zakonczenie generatorow ECP
	wait_for_task_termination(false, 2, lib::irp6ot_m::ROBOT_NAME.c_str(), lib::festival::ROBOT_NAME.c_str());

	// FAZA POWROTU DO USTAWIENIA POCZATKOWEGO

	//set_next_ecp_state(ecp_mp::generator::ECP_GEN_NEWSMOOTH, 0, "trj/multiplayer/irp6ot_sm_init.trj", 0, lib::irp6ot_m::ROBOT_NAME);
	set_next_ecp_state(ecp_mp::task::ECP_GEN_FESTIVAL, ecp::festival::generator::generator::POLISH_VOICE, "zadanie wykonane", 0, lib::festival::ROBOT_NAME);
	// uruchomienie generatora empty_gen i oczekiwanie na zakonczenie generatorow ECP
