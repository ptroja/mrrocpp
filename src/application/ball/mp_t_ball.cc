...
void ball::configure_edp_force_sensor(bool configure_track, bool configure_postument)
{
    ...
    {
        run_extended_empty_generator_for_set_of_robots_and_wait_for_task_termination_message_of_another_set_of_robots
                (2, 2, lib::ROBOT_IRP6OT_M.c_str(), lib::ROBOT_IRP6P_M.c_str(),
...
void ball::main_task_algorithm(void)
{
	...
	set_next_ecps_state ((int) ecp_mp::task::ECP_GEN_SMOOTH, (int) ecp_mp::task::ABSOLUTE, "src/application/ball/irp6ot_init.trj", 0, 1, lib::ROBOT_IRP6OT_M.c_str());
	set_next_ecps_state ((int) ecp_mp::task::ECP_GEN_SMOOTH, (int) ecp_mp::task::ABSOLUTE, "src/application/ball/irp6p_init.trj", 0, 1, lib::ROBOT_IRP6P_M.c_str());
	...
	run_extended_empty_generator_for_set_of_robots_and_wait_for_task_termination_message_of_another_set_of_robots
   	...
   	set_next_ecps_state ((int) ecp_mp::task::ECP_GEN_TRANSPARENT, 0, "", 0, 1, lib::ROBOT_IRP6OT_M.c_str());
   	set_next_ecps_state ((int) ecp_mp::task::ECP_GEN_TRANSPARENT, 0, "", 0, 1, lib::ROBOT_IRP6P_M.c_str());
