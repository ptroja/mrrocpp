...
{
	memcpy(&mp_ecp_smb_multi_pin_locking_structure, ecp_t.mp_command.ecp_next_state.string_data, sizeof(mp_ecp_smb_multi_pin_locking_structure));
}
...
{
	memcpy(&mp_ecp_smb_multi_pin_insertion_structure, ecp_t.mp_command.ecp_next_state.string_data, sizeof(mp_ecp_smb_multi_pin_insertion_structure));
}
