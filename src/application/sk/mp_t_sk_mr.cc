...
void sk_mr::main_task_algorithm(void)
{
	...
	set_next_ecps_state((int) ecp_mp::task::ECP_GEN_TFG, (int) 5, tmp_string, sizeof(mp_ecp_tfg_command), 1, gripper_name.c_str());
	/*
	...
	set_next_ecps_state((int) ecp_mp::task::ECP_GEN_BIAS_EDP_FORCE, (int) 5, "", 0, 1, manipulator_name.c_str());
	...
	set_next_ecps_state((int) ecp_mp::task::ECP_GEN_TFF_NOSE_RUN, (int) 5, "", 0, 1, manipulator_name.c_str());
	...
	set_next_ecps_state((int) ecp_mp::task::ECP_GEN_EDGE_FOLLOW_FORCE, (int) 5, "", 0, 1, manipulator_name.c_str());
