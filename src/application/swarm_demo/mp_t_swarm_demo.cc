...
void swarm_demo::main_task_algorithm(void)
{
	...
	set_next_ecps_state(ecp_mp::sub_task::ECP_ST_SMOOTH_ANGLE_AXIS_FILE_FROM_MP, (int) 5, "../../src/application/swarm_demo/trajectory_track_angle_2.trj", 0, 1, lib::irp6ot_m::ROBOT_NAME.c_str());
	run_extended_empty_gen_and_wait(1, 1, lib::irp6ot_m::ROBOT_NAME.c_str(), lib::irp6ot_m::ROBOT_NAME.c_str());

	set_next_ecps_state(ecp_mp::sub_task::ECP_ST_SMOOTH_ANGLE_AXIS_FILE_FROM_MP, (int) 5, "../../src/application/swarm_demo/trajectory_postument_angle_2.trj", 0, 1, lib::irp6p_m::ROBOT_NAME.c_str());
