	...
	common::task::task(_config)
{
	...
	if (config.section_name == lib::get_ecp_section(lib::irp6ot_tfg::ROBOT_NAME)) {
		ecp_m_robot = (boost::shared_ptr <robot_t>) new irp6ot_tfg::robot(*this);
	} else if (config.section_name == lib::get_ecp_section(lib::irp6p_tfg::ROBOT_NAME)) {
		ecp_m_robot = (boost::shared_ptr <robot_t>) new irp6p_tfg::robot(*this);
	} else if (config.section_name == lib::get_ecp_section(lib::irp6ot_m::ROBOT_NAME)) {
		ecp_m_robot = (boost::shared_ptr <robot_t>) new irp6ot_m::robot(*this);
	} else if (config.section_name == lib::get_ecp_section(lib::irp6p_m::ROBOT_NAME)) {
		ecp_m_robot = (boost::shared_ptr <robot_t>) new irp6p_m::robot(*this);
	} else if (config.section_name == lib::get_ecp_section(lib::conveyor::ROBOT_NAME)) {
		ecp_m_robot = (boost::shared_ptr <robot_t>) new conveyor::robot(*this);
	} else if (config.section_name == lib::get_ecp_section(lib::polycrank::ROBOT_NAME)) {
