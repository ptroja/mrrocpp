...
void swarm_demo::main_task_algorithm(void)
{
	...
	set_next_ecp_state(ecp_mp::generator::ECP_ST_SMOOTH_JOINT_FILE_FROM_MP, 5, "../../src/application/swarm_demo_irp6/trajectory_track_joint.trj", lib::irp6ot_m::ROBOT_NAME);
	set_next_ecp_state(ecp_mp::generator::ECP_ST_SMOOTH_JOINT_FILE_FROM_MP, 5, "../../src/application/swarm_demo_irp6/trajectory_postument_joint.trj", lib::irp6p_m::ROBOT_NAME);
	...
	set_next_ecp_state(ecp_mp::generator::ECP_ST_SMOOTH_ANGLE_AXIS_FILE_FROM_MP, 5, "../../src/application/swarm_demo_irp6/trajectory_postument_angle_p1.trj", lib::irp6p_m::ROBOT_NAME);
	...
	set_next_ecp_state(ecp_mp::generator::ECP_ST_SMOOTH_JOINT_FILE_FROM_MP, 5, "../../src/application/swarm_demo_irp6/trajectory_track_joint_p1.trj", lib::irp6ot_m::ROBOT_NAME);
	wait_for_task_termination(false, 1, lib::irp6ot_m::ROBOT_NAME.c_str());

	sr_ecp_msg->message("Track angle axis");

	set_next_ecp_state(ecp_mp::generator::ECP_ST_SMOOTH_ANGLE_AXIS_FILE_FROM_MP, 5, "../../src/application/swarm_demo_irp6/trajectory_track_angle_p1a.trj", lib::irp6ot_m::ROBOT_NAME);
	wait_for_task_termination(false, 1, lib::irp6ot_m::ROBOT_NAME.c_str());
	...
	set_next_ecp_state(ecp_mp::generator::ECP_ST_SMOOTH_ANGLE_AXIS_FILE_FROM_MP, 5, "../../src/application/swarm_demo_irp6/trajectory_postument_angle_p2.trj", lib::irp6p_m::ROBOT_NAME);
	wait_for_task_termination(false, 1, lib::irp6p_m::ROBOT_NAME.c_str());
	...
	set_next_ecp_state(ecp_mp::generator::ECP_ST_SMOOTH_ANGLE_AXIS_FILE_FROM_MP, 5, "../../src/application/swarm_demo_irp6/trajectory_track_angle_p2.trj", lib::irp6ot_m::ROBOT_NAME);
	wait_for_task_termination(false, 1, lib::irp6ot_m::ROBOT_NAME.c_str());
	...
	set_next_ecp_state(ecp_mp::generator::ECP_ST_SMOOTH_ANGLE_AXIS_FILE_FROM_MP, 5, "../../src/application/swarm_demo_irp6/trajectory_track_angle.trj", lib::irp6ot_m::ROBOT_NAME);
	set_next_ecp_state(ecp_mp::generator::ECP_ST_SMOOTH_ANGLE_AXIS_FILE_FROM_MP, 5, "../../src/application/swarm_demo_irp6/trajectory_postument_angle.trj", lib::irp6p_m::ROBOT_NAME);
	wait_for_task_termination(false, 2, lib::irp6ot_m::ROBOT_NAME.c_str(), lib::irp6p_m::ROBOT_NAME.c_str());
