...
void bird_hand_test::main_task_algorithm(void)
{
	...
	set_next_ecps_state((int) ecp_mp::task::ECP_GEN_TRANSPARENT, (int) 0, "", 0, 1, lib::ROBOT_BIRD_HAND.c_str());

	send_end_motion_to_ecps(1, lib::ROBOT_BIRD_HAND.c_str());

	sr_ecp_msg->message("4");

	set_next_ecps_state((int) ecp_mp::task::ECP_GEN_BIRD_HAND, (int) 5, "", 0, 1, lib::ROBOT_BIRD_HAND.c_str());
