...
#include "ecp_mp/sensor/ecp_mp_s_pawel.h"		// zawiera klase ecp_mp_sensor
...
/***************************** CONSTRUCTOR ********************************/
pawel::pawel (lib::SENSOR_t _sensor_name, const char* _section_name, task::task& _ecp_mp_object):
