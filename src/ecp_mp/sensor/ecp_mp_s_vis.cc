...
#include "ecp_mp/sensor/ecp_mp_s_vis.h"		// zawiera klase ecp_mp_sensor
...
/***************************** CONSTRUCTOR ********************************/
vis::vis (lib::SENSOR_ENUM _sensor_name, const char* _section_name, task::task& _ecp_mp_object):
