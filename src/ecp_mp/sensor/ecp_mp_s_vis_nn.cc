...
#include "ecp_mp/sensor/ecp_mp_s_vis_nn.h"		// zawiera klase ecp_mp_vis_nn_sensor
...
/***************************** CONSTRUCTOR ********************************/
vis_nn::vis_nn (lib::SENSOR_ENUM _sensor_name, const char* _section_name, task::task& _ecp_mp_object):
