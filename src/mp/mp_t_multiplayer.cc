...
void multiplayer::main_task_algorithm(void)
{
  	...
  	//mp_playerspeech_generator playerspeech_gen(*this); 
   	//playerspeech_gen.transmitter_m = this->transmitter_m;
			...
			set_next_ecps_state (ecp_mp::task::ECP_GEN_FESTIVAL, ecp::common::festival_generator::POLISH_VOICE, "inicjalizuje~ zadanie", 1, ROBOT_FESTIVAL);
			...
			set_next_ecps_state (ecp_mp::task::ECP_GEN_FESTIVAL, ecp::common::festival_generator::POLISH_VOICE, "oczekuje~ na polecenie", 1, ROBOT_FESTIVAL);
			// uruchomienie generatora empty_gen i oczekiwanie na zakonczenie generatorow ECP
			run_extended_empty_generator_for_set_of_robots_and_wait_for_task_termination_message_of_another_set_of_robots
			...
			do
			{
				...
				set_next_ecps_state (ecp_mp::task::ECP_GEN_FESTIVAL, ecp::common::festival_generator::POLISH_VOICE, komunikat, 1, ROBOT_FESTIVAL);
				// uruchomienie generatora empty_gen i oczekiwanie na zakonczenie generatorow ECP
				run_extended_empty_generator_for_set_of_robots_and_wait_for_task_termination_message_of_another_set_of_robots
			        (1, 1, ROBOT_FESTIVAL, ROBOT_FESTIVAL);
			...
			set_next_playerpos_goal (ROBOT_ELECTRON, goal);
			set_next_ecps_state (ecp_mp::task::ECP_GEN_FESTIVAL, ecp::common::festival_generator::POLISH_VOICE, "jade~ przekazac~ kostke~", 1, ROBOT_FESTIVAL);
			...
			set_next_ecps_state (ecp_mp::task::ECP_GEN_FESTIVAL, ecp::common::festival_generator::POLISH_VOICE, "drugi robot podniesie kostke~", 1, ROBOT_FESTIVAL);
			...
			set_next_ecps_state (ecp_mp::task::ECP_GEN_FESTIVAL, ecp::common::festival_generator::POLISH_VOICE, "prosze~ odbierz kostke~", 1, ROBOT_FESTIVAL);
			// uruchomienie generatora empty_gen i oczekiwanie na zakonczenie generatorow ECP
			run_extended_empty_generator_for_set_of_robots_and_wait_for_task_termination_message_of_another_set_of_robots(
					2, 2,
					ROBOT_IRP6_ON_TRACK, ROBOT_FESTIVAL,
			...
			set_next_ecps_state( (int) ecp_mp::task::ECP_GEN_SMOOTH, 0, "trj/multiplayer/irp6ot_sm_init.trj", 1, ROBOT_IRP6_ON_TRACK);
			set_next_ecps_state (ecp_mp::task::ECP_GEN_FESTIVAL, ecp::common::festival_generator::POLISH_VOICE, "zadanie wykonane", 1, ROBOT_FESTIVAL);
			// uruchomienie generatora empty_gen i oczekiwanie na zakonczenie generatorow ECP
			run_extended_empty_generator_for_set_of_robots_and_wait_for_task_termination_message_of_another_set_of_robots(
					2, 2,
