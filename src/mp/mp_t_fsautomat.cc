...
std::map<char *, common::State, ecp::common::task::ecp_task::str_cmp> * fsautomat::takeStatesMap()
{
	int size;
	char *filePath;
	char *fileName = config.return_string_value("xml_file", "[xml_settings]");
	xmlNode *cur_node, *child_node;
	std::map<char *, common::State, ecp::common::task::ecp_task::str_cmp> * statesMap = new std::map<char *, common::State, ecp::common::task::ecp_task::str_cmp>();
...
void fsautomat::main_task_algorithm(void)
{
	...
	std::map<char *, common::State, ecp::common::task::ecp_task::str_cmp> * stateMap = takeStatesMap();
