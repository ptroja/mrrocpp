...
mp_task_vis_sac::mp_task_vis_sac(configurator &_config) : mp_task(_config)
{
}
...
void mp_task_vis_sac::task_initialization(void) 
{
	...
	sensor_m[SENSOR_CAMERA_SA] = 
		new ecp_mp_vis_sac_sensor (SENSOR_CAMERA_SA, "[vsp_vis]", *this); //change if SENSOR_CAMERA_SA used for nonnn recog (vsp_vis_pbeolsac)
