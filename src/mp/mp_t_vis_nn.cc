...
void mp_task_vis_nn::task_initialization(void)
{
	...
	sensor_m[SENSOR_CAMERA_SA] = new ecp_mp::sensor::ecp_mp_vis_nn_sensor (SENSOR_CAMERA_SA, "[vsp_nn]", *this); //change if SENSOR_CAMERA_SA used for nonnn recog (vsp_vis_pbeolsac)
