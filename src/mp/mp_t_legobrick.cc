...
/*
void mp_task_lego_brick::initiate(CUBE_COLOR up_is, CUBE_COLOR down_is, CUBE_COLOR front_is,
...
void mp_task_lego_brick::task_initialization(void)
{
    /*
    // Powolanie czujnikow
...
void mp_task_lego_brick::main_task_algorithm(void)
{
/*
    break_state = false;
