...
bool vis_sac_lx::first_step ()
{
    ...
    //TOOL
    irp6ot->ecp_td.next_tool_frame[0][0]=1;
    irp6ot->ecp_td.next_tool_frame[1][0]=0;
    irp6ot->ecp_td.next_tool_frame[2][0]=0;
    irp6ot->ecp_td.next_tool_frame[0][3]=0;

    irp6ot->ecp_td.next_tool_frame[0][1]=0;
    irp6ot->ecp_td.next_tool_frame[1][1]=1;
    irp6ot->ecp_td.next_tool_frame[2][1]=0;
    irp6ot->ecp_td.next_tool_frame[1][3]=0;

    irp6ot->ecp_td.next_tool_frame[0][2]=0;
    irp6ot->ecp_td.next_tool_frame[1][2]=0;
    irp6ot->ecp_td.next_tool_frame[2][2]=1;
