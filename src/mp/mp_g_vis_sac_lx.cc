...
//			measure[i][j]=0;
	...
	irp6ot->ecp_td.next_tool_frame[2][2]=1; irp6ot->ecp_td.next_tool_frame[2][3]=0.25; //0.25;
...
bool mp_vis_sac_lx_generator::next_step () {
 ...
 // UWAGA: dzialamy na jednoelementowej liscie robotow
	...
	if(node_counter==1 || node_counter==2)
	{
		...
		O_Tx_E.set_frame_tab(irp6ot->ecp_td.MPcurrent_predicted_arm_frame); // zarem
...
//std::cout << O_Tx_G;
	...
	O_Tx_E.set_frame_tab(irp6ot->ecp_td.MPcurrent_predicted_arm_frame);
	O_Tx_E.get_xyz_angle_axis(O_r_E[0]);
