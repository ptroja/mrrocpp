...
boost::shared_ptr<effector> master; // Bufor polecen i odpowiedzi EDP_MASTER

boost::shared_ptr<shell> edp_shell; // obiekt do wykrywania obecnosci drugiego edp jeszcze przed powolaniem klasy efectora
