...
void qmpw_init(  );
messip_cnx_t *messip_connect(const char *mgr_ref,
   int32_t msec_timeout );
messip_cnx_t *messip_connect0(const char *mgr_ref,
   int32_t msec_timeout,
   pid_t pid,
   pthread_t tid );
int
...
int messip_channel_delete( messip_channel_t * ch,
   int32_t msec_timeout );
messip_channel_t *messip_channel_connect( messip_cnx_t * cnx,
   const char *name,
   int32_t msec_timeout );
int messip_channel_disconnect( messip_channel_t * ch,
   int32_t msec_timeout );
int messip_channel_ping( messip_channel_t * ch,
   int32_t msec_timeout );
int messip_receive( messip_channel_t * ch,
   int32_t * type,
   int32_t * subtype,
   void *buffer,
   int32_t maxlen,
   int32_t msec_timeout );
int messip_reply( messip_channel_t * ch,
   int index,
   int32_t answer,
...
int messip_send( messip_channel_t * ch,
   ...
   int reply_maxlen,
   int32_t msec_timeout );
int32_t messip_buffered_send( messip_channel_t * ch,
   int32_t type,
   int32_t subtype,
   void *send_buffer,
   int send_len,
