...
int EDP_irp6_on_track_synchronise()
{
	try
	{
		...
		{
			ui_robot.irp6_on_track->synchronise();
			ui_state.irp6_on_track.edp.is_synchronised = ui_robot.irp6_on_track->is_synchronised();
		}
	...
	try
	{
		if (ui_state.irp6_on_track.edp.state == 0)
		{
			...
			)
			{
				...
				ui_robot.irp6_on_track = new ui_irp6_on_track_robot(&ui_state.irp6_on_track.edp, *config, ui_msg.all_ecp);
				ui_state.irp6_on_track.edp.pid = ui_robot.irp6_on_track->get_EDP_pid();
...
reload_irp6ot_configuration()
{
	...
	// sekcja dla robota irp6 on_track	
