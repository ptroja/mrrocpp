...
int
close_wnd_speaker_play( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
...
int
start_wind_speaker_play( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
...
int
clear_wind_speaker_play_flag( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
...
int
init_wnd_speaker_play( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
{
...
int
speaker_preset_sound_play( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
...
int
speaker_play_exec( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
	...
	PtGetResource(ABW_PtText_wnd_speaker_play_text_entry, Pt_ARG_TEXT_STRING, &ref_local_text, 0 );
	PtGetResource(ABW_PtComboBox_wnd_speaker_play_prosody_entry, Pt_ARG_TEXT_STRING, &ref_local_prosody, 0 );
	strcpy(local_text, ref_local_text);
	strcpy(local_prosody, ref_local_prosody);	
...
int
speaker_check_state( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
	...
	if (ui_state.speaker.edp.pid!=-1)
	{
		...
		if (ui_robot.speaker->speaking_state) { // odtwarzanie w toku
			PtSetResource(ABW_PtLabel_wnd_speaker_play_status, Pt_ARG_TEXT_STRING, "busy" , 0);
		} else {
			PtSetResource(ABW_PtLabel_wnd_speaker_play_status, Pt_ARG_TEXT_STRING, "ready" , 0);
		}
...
int
EDP_speaker_create( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
...
int
EDP_speaker_slay( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
...
int
pulse_reader_speaker_start( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
	...
	if (pulse_reader_speaker_start_exec_pulse()) process_control_window_init(widget, apinfo, cbinfo);
...
int
pulse_reader_speaker_stop( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
	...
	if (pulse_reader_speaker_stop_exec_pulse()) process_control_window_init(widget, apinfo, cbinfo);
...
int
pulse_reader_speaker_trigger( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
	...
	if (pulse_reader_speaker_trigger_exec_pulse()) process_control_window_init(widget, apinfo, cbinfo);
...
int
pulse_ecp_speaker( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
...
manage_interface_speaker ()
{
	switch (ui_state.speaker.edp.state)
	{
		case -1:
			...
			replySend(new Message('E','D','A',0,NULL,NULL));
		break;
		case 0:
			...
			replySend(new Message('E','D','B',0,NULL,NULL));

		break;
		case 1:
		case 2:
			ApModifyItemState( &robot_menu, AB_ITEM_NORMAL, ABN_mm_speaker, NULL);
			replySend(new Message('E','D','C',0,NULL,NULL));
