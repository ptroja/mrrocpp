...
NL_regulator_polycrank::NL_regulator_polycrank(uint8_t reg_no, uint8_t reg_par_no, double aa, double bb0, double bb1, double k_ff, common::motor_driven_effector &_master) :
