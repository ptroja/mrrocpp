...
robot::robot(lib::configurator &_config, lib::sr_ecp &_sr_ecp) :
	robot::ecp_robot(lib::spkm::ROBOT_SPKM, SPKM_NUM_OF_SERVOS, lib::spkm::EDP_SPKM_SECTION, _config, _sr_ecp),
...
robot::robot(common::task::task& _ecp_object) :
	robot::ecp_robot(lib::spkm::ROBOT_SPKM, SPKM_NUM_OF_SERVOS, lib::spkm::EDP_SPKM_SECTION, _ecp_object), kinematics_manager(),
