...
public:
	...
	/*! Computes platform pose on the base of given _O_S_T.
	 * @param _O_S_T Pose of the middle of the spherical wrist (S) in the O (lower PM platform) reference frame.
	 ...
	 */
	Vector3d SW_inverse(const Homog4d & P_W_T_);
