...
robot::robot(lib::configurator &_config, lib::sr_ecp &_sr_ecp) :
	robot::ecp_robot(lib::sarkofag::ROBOT_SARKOFAG, lib::sarkofag::NUM_OF_SERVOS, lib::sarkofag::EDP_SECTION, _config, _sr_ecp),
			kinematics_manager()
{
...
robot::robot(common::task::task& _ecp_object) :
	robot::ecp_robot(lib::sarkofag::ROBOT_SARKOFAG, lib::sarkofag::NUM_OF_SERVOS, lib::sarkofag::EDP_SECTION, _ecp_object),
			kinematics_manager()
{
	//  Stworzenie listy dostepnych kinematyk.
	create_kinematic_models_for_given_robot();
