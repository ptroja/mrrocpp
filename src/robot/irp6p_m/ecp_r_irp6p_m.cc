...
robot::robot(lib::configurator &_config, lib::sr_ecp &_sr_ecp) :
			robot::ecp_robot(lib::irp6p_m::ROBOT_NAME, lib::irp6p_m::IRP6P_M_NUM_OF_SERVOS, lib::irp6p_m::EDP_SECTION, _config, _sr_ecp),
			kinematics_manager()
{
...
robot::robot(common::task::task& _ecp_object) :
	robot::ecp_robot(lib::irp6p_m::ROBOT_NAME, lib::irp6p_m::IRP6P_M_NUM_OF_SERVOS, lib::irp6p_m::EDP_SECTION, _ecp_object),
			kinematics_manager()
{
	//  Stworzenie listy dostepnych kinematyk.
	create_kinematic_models_for_given_robot();
