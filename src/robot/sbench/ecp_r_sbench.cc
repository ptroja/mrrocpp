...
robot::robot(lib::configurator &_config, lib::sr_ecp &_sr_ecp) :
		ecp::common::robot::ecp_robot(lib::sbench::ROBOT_NAME, lib::sbench::NUM_OF_SERVOS, _config, _sr_ecp), sbench_head_soldification_data_port(lib::sbench::PINS_ACTIVATION_DATA_PORT, port_manager), sbench_reply_data_request_port(lib::sbench::REPLY_DATA_REQUEST_PORT, port_manager)
{
...
robot::robot(common::task::task_base& _ecp_object) :
		ecp::common::robot::ecp_robot(lib::sbench::ROBOT_NAME, lib::sbench::NUM_OF_SERVOS, _ecp_object), sbench_head_soldification_data_port(lib::sbench::PINS_ACTIVATION_DATA_PORT, port_manager), sbench_reply_data_request_port(lib::sbench::REPLY_DATA_REQUEST_PORT, port_manager)
{
	//  Stworzenie listy dostepnych kinematyk.
	create_kinematic_models_for_given_robot();
}
