...
#define PLAYER_NULL_STRING           (char*)"null"
#define PLAYER_PLAYER_STRING         (char*)"player"
#define PLAYER_POWER_STRING          (char*)"power"
#define PLAYER_GRIPPER_STRING        (char*)"gripper"
#define PLAYER_POSITION_STRING       (char*)"position"
#define PLAYER_SONAR_STRING          (char*)"sonar"
#define PLAYER_LASER_STRING          (char*)"laser"
#define PLAYER_BLOBFINDER_STRING     (char*)"blobfinder"
#define PLAYER_PTZ_STRING            (char*)"ptz"
#define PLAYER_AUDIO_STRING          (char*)"audio"
#define PLAYER_FIDUCIAL_STRING       (char*)"fiducial"
#define PLAYER_SPEECH_STRING         (char*)"speech"
#define PLAYER_SPEECH_RECOGNITION_STRING   (char*)"speech_recognition"
#define PLAYER_GPS_STRING            (char*)"gps"
#define PLAYER_BUMPER_STRING         (char*)"bumper"
#define PLAYER_TRUTH_STRING          (char*)"truth"
#define PLAYER_IDARTURRET_STRING     (char*)"idarturret"
#define PLAYER_IDAR_STRING           (char*)"idar"
#define PLAYER_DESCARTES_STRING      (char*)"descartes"
#define PLAYER_DIO_STRING            (char*)"dio"
#define PLAYER_AIO_STRING            (char*)"aio"
#define PLAYER_IR_STRING             (char*)"ir"
#define PLAYER_WIFI_STRING           (char*)"wifi"
#define PLAYER_WAVEFORM_STRING       (char*)"waveform"
#define PLAYER_LOCALIZE_STRING       (char*)"localize"
#define PLAYER_MCOM_STRING           (char*)"mcom"
#define PLAYER_SOUND_STRING	     (char*)"sound"
#define PLAYER_AUDIODSP_STRING       (char*)"audiodsp"
#define PLAYER_AUDIOMIXER_STRING     (char*)"audiomixer"
#define PLAYER_MOTOR_STRING          (char*)"motor"
#define PLAYER_POSITION2D_STRING     (char*)"position2d"
#define PLAYER_POSITION3D_STRING     (char*)"position3d"
#define PLAYER_SERVICE_ADV_STRING    (char*)"service_adv"
#define PLAYER_SIMULATION_STRING     (char*)"simulation"
#define PLAYER_BLINKENLIGHT_STRING   (char*)"blinkenlight"
#define PLAYER_NOMAD_STRING          (char*)"nomad"
#define PLAYER_ENERGY_STRING         (char*)"energy"
#define PLAYER_MAP_STRING            (char*)"map"
#define PLAYER_PLANNER_STRING        (char*)"planner"
#define PLAYER_LOG_STRING            (char*)"log"
#define PLAYER_CAMERA_STRING         (char*)"camera"
#define PLAYER_JOYSTICK_STRING       (char*)"joystick"
#define PLAYER_OPAQUE_STRING         (char*)"opaque"
...
///   The fiducial id.  Fiducials that cannot be identified get id -1. 
  ...
  /** Uncertainty in fiducial orientation relative to the detector
      (r, p, y) in millirad. */
  int32_t urot[3];
  int16_t begin_index,end_index;
  int32_t begin_x,end_x;
  int32_t begin_y,end_y;
  int32_t extra[4];
/*  union {
  int32_t arc_radius;
  int32_t mid_x;
...
#define R(LASER_POINT) (double) (this->ldata.ranges[(int)LASER_POINT])
#define B(LASER_POINT) (double) (this->ldata.min_angle + LASER_POINT * this->ldata.resolution) / 100.0 * M_PI / 180.0
#define X(LASER_POINT) (double) R(LASER_POINT)*cos(B(LASER_POINT))
#define Y(LASER_POINT) (double) R(LASER_POINT)*sin(B(LASER_POINT))
#define R_XY(XY) sqrt((XY.x*XY.x)+(XY.y*XY.y)) // in mm
#define B_XY(XY) atan2(XY.y,XY.x)// in radians //*180/M_PI
#define LASER_POINT_B(B) ((B*18000.0/M_PI-this->ldata.min_angle)/this->ldata.resolution)

#define PLAYER_FEATURE_TYPE_ARC 1
#define PLAYER_FEATURE_TYPE_LINE 6
/// possible leg
#define PLAYER_FEATURE_TYPE_PLEG 7
/// possible 2 legs in same segment
#define PLAYER_FEATURE_TYPE_2LEGS 8
/// confirmed person leg
#define PLAYER_FEATURE_TYPE_LEG 10
/// a person
#define PLAYER_FEATURE_TYPE_PERSON 11
/// person legs
//#define PLAYER_FEATURE_TYPE_PERSON_LEGS 12
/// ualg entrance hall column
///#define PLAYER_FEATURE_TYPE_COLUMN 20
///#define PLAYER_FEATURE_TYPE_BENCH 21
// #define TIME_DIFF(AS,AU,BS,BU) fabs((AS + AU / 1000000.0) - (BS + BU/ 1000000.0))
/// ualg entrance hall bench
/** @} */
/** @} */
#endif /* PLAYER_H */
