...
/*-----------------------------------------------------------------------*/
NL_regulator_1_irp6p::NL_regulator_1_irp6p (BYTE reg_no, BYTE reg_par_no, double aa, double bb0, double bb1, double k_ff, edp_irp6s_and_conv_effector &_master)
...
/*-----------------------------------------------------------------------*/
NL_regulator_2_irp6p::NL_regulator_2_irp6p (BYTE reg_no, BYTE reg_par_no, double aa, double bb0, double bb1, double k_ff, edp_irp6s_and_conv_effector &_master)
        : NL_regulator(reg_no, reg_par_no, aa, bb0, bb1, k_ff, _master)
{
    // Konstruktor regulatora konkretnego
    // Przy inicjacji nalezy dopilnowac, zeby numery algorytmu regulacji oraz zestawu jego parametrow byly
...
/*-----------------------------------------------------------------------*/
NL_regulator_3_irp6p::NL_regulator_3_irp6p (BYTE reg_no, BYTE reg_par_no, double aa, double bb0, double bb1, double k_ff, edp_irp6s_and_conv_effector &_master)
        : NL_regulator(reg_no, reg_par_no, aa, bb0, bb1, k_ff, _master)
{
    // Konstruktor regulatora konkretnego
    // Przy inicjacji nalezy dopilnowac, zeby numery algorytmu regulacji oraz zestawu jego parametrow byly
...
/*-----------------------------------------------------------------------*/
NL_regulator_4_irp6p::NL_regulator_4_irp6p (BYTE reg_no, BYTE reg_par_no, double aa, double bb0, double bb1, double k_ff, edp_irp6s_and_conv_effector &_master)
        : NL_regulator(reg_no, reg_par_no, aa, bb0, bb1, k_ff, _master)
{
    // Konstruktor regulatora konkretnego
    // Przy inicjacji nalezy dopilnowac, zeby numery algorytmu regulacji oraz zestawu jego parametrow byly
...
/*-----------------------------------------------------------------------*/
NL_regulator_5_irp6p::NL_regulator_5_irp6p (BYTE reg_no, BYTE reg_par_no, double aa, double bb0, double bb1, double k_ff, edp_irp6s_and_conv_effector &_master)
        : NL_regulator(reg_no, reg_par_no, aa, bb0, bb1, k_ff, _master)
{
    // Konstruktor regulatora konkretnego
    // Przy inicjacji nalezy dopilnowac, zeby numery algorytmu regulacji oraz zestawu jego parametrow byly
...
/*-----------------------------------------------------------------------*/
NL_regulator_6_irp6p::NL_regulator_6_irp6p (BYTE reg_no, BYTE reg_par_no, double aa, double bb0, double bb1, double k_ff, edp_irp6s_and_conv_effector &_master)
        : NL_regulator(reg_no, reg_par_no, aa, bb0, bb1, k_ff, _master)
{
    // Konstruktor regulatora konkretnego
    // Przy inicjacji nalezy dopilnowac, zeby numery algorytmu regulacji oraz zestawu jego parametrow byly
...
/*-----------------------------------------------------------------------*/
NL_regulator_7_irp6p::NL_regulator_7_irp6p (BYTE reg_no, BYTE reg_par_no, double aa, double bb0, double bb1, double k_ff, edp_irp6s_and_conv_effector &_master)
        : NL_regulator(reg_no, reg_par_no, aa, bb0, bb1, k_ff, _master)
{
    // Konstruktor regulatora konkretnego
    // Przy inicjacji nalezy dopilnowac, zeby numery algorytmu regulacji oraz zestawu jego parametrow byly
...
/*-----------------------------------------------------------------------*/
NL_regulator_8_irp6p::NL_regulator_8_irp6p (BYTE reg_no, BYTE reg_par_no, double aa, double bb0, double bb1, double k_ff, edp_irp6s_and_conv_effector &_master)
        : NL_regulator(reg_no, reg_par_no, aa, bb0, bb1, k_ff, _master)
{
...
/*-----------------------------------------------------------------------*/
BYTE NL_regulator_1_irp6p::compute_set_value (void)
{
    ...
    BYTE alg_par_status;   // okresla prawidlowosc numeru algorytmu regulacji
    ...
    constraint_detector(SG_REG_1_MAX_ACC, SG_REG_1_MAX_SPEED);

    // przeliczenie radianow na impulsy
    // step_new_pulse = step_new*IRP6_POSTUMENT_INC_PER_REVOLUTION/(2*M_PI); // ORIGINAL
    step_new_pulse = step_new*IRP6_POSTUMENT_AXE_0_TO_5_INC_PER_REVOLUTION/(2*M_PI);
...
// kolumna i tak dalej
/*-----------------------------------------------------------------------*/
BYTE NL_regulator_2_irp6p::compute_set_value (void)
{
    // algorytm regulacji dla serwomechanizmu
    ...
    */
    ...
    case 2:  // algorytm nr 2 - sterowanie pradowe
        // DUNG START
        current_desired = 0.4*9.52 * (master.new_instruction.arm.coordinate_def.desired_torque[0] / 158);
        ...
        {
            display = 0;
            //printf("joint 1:   desired_current = %f,    current_error = %f,    out = %f\n", master.new_instruction.arm.coordinate_def.desired_torque[0] / 158, current_error, -30 * current_error - 4.0*int_current_error);
        }
        // DUNG END
        break;
    default: // w tym miejscu nie powinien wystapic blad zwiazany z
...
/*-----------------------------------------------------------------------*/
BYTE NL_regulator_3_irp6p::compute_set_value (void)
{
    // algorytm regulacji dla serwomechanizmu
    ...
    */
    ...
    case 2:  // algorytm nr 2 - sterowanie pradowe
        // DUNG START
        current_desired = 0.4*9.52 * (master.new_instruction.arm.coordinate_def.desired_torque[1] / 158);
        current_measured = (meassured_current - 128 - 3)*0.035;
        current_error = current_desired - current_measured;
        int_current_error =  int_current_error + current_error*0.02;		// 500Hz => 0.02s
        //int_current_error = 0;
...
/*-----------------------------------------------------------------------*/
BYTE NL_regulator_4_irp6p::compute_set_value (void)
{
    // algorytm regulacji dla serwomechanizmu
    ...
    */
    ...
    case 2:  // algorytm nr 2 - sterowanie pradowe
        // DUNG START
        current_desired = 0.4*9.52 * (master.new_instruction.arm.coordinate_def.desired_torque[2] / 158);
        current_measured = (meassured_current - 128 - 3)*0.035;
        current_error = current_desired - current_measured;
        int_current_error =  int_current_error + current_error*0.02;		// 500Hz => 0.02s
        //int_current_error = 0;
...
/*-----------------------------------------------------------------------*/
BYTE NL_regulator_5_irp6p::compute_set_value (void)
{
    // algorytm regulacji dla serwomechanizmu
    ...
    */
    ...
    case 2:  // algorytm nr 2 - sterowanie pradowe
        // DUNG START
        current_desired = 0.4*9.52 * (master.new_instruction.arm.coordinate_def.desired_torque[3] / 158);
        current_measured = (meassured_current - 128 - 3)*0.035;
        current_error = current_desired - current_measured;
        int_current_error =  int_current_error + current_error*0.02;		// 500Hz => 0.02s
        //int_current_error = 0;
        ...
        {
            display = 0;
            printf("joint 4:   desired_current = %f,    current_error = %f,    out = %f\n", master.new_instruction.arm.coordinate_def.desired_torque[3] / 158, current_error, -30 * current_error - 4.0*int_current_error);
        }
        // DUNG END
        break;
    default: // w tym miejscu nie powinien wystapic blad zwiazany z
...
/*-----------------------------------------------------------------------*/
BYTE NL_regulator_6_irp6p::compute_set_value (void)
{
    // algorytm regulacji dla serwomechanizmu
    ...
    */
    ...
    case 2:  // algorytm nr 2 - sterowanie pradowe
        // DUNG START
        current_desired = 0.4*9.52 * (master.new_instruction.arm.coordinate_def.desired_torque[4] / 158);
        current_measured = (meassured_current - 128 - 3)*0.035;
        current_error = current_desired - current_measured;
        int_current_error =  int_current_error + current_error*0.02;		// 500Hz => 0.02s
        //int_current_error = 0;
        ...
        {
            display = 0;
            //printf("joint 5:   desired_current = %f,    current_error = %f,    out = %f\n", master.new_instruction.arm.coordinate_def.desired_torque[4] / 158, current_error, -30 * current_error - 4.0*int_current_error);
        }
        // DUNG END
        break;
    default: // w tym miejscu nie powinien wystapic blad zwiazany z
...
/*-----------------------------------------------------------------------*/
BYTE NL_regulator_7_irp6p::compute_set_value (void)
{
    // algorytm regulacji dla serwomechanizmu
    ...
    // BY Y i S - uwzglednie ograniczen na predkosc i przyspieszenie
    constraint_detector(SG_REG_7_MAX_ACC, SG_REG_7_MAX_SPEED);

    // przeliczenie radianow na impulsy
    // step_new_pulse = step_new*IRP6_POSTUMENT_AXE_6_INC_PER_REVOLUTION/(2*M_PI); // ORIGINAL
    step_new_pulse = step_new*IRP6_POSTUMENT_AXE_6_INC_PER_REVOLUTION/(2*M_PI);
    ...
    */
    ...
    case 2:  // algorytm nr 2 - sterowanie pradowe
        // DUNG START
        current_desired = 0.4*9.52 * (master.new_instruction.arm.coordinate_def.desired_torque[5] / 158);
        ...
        {
            display = 0;
            printf("joint 6:   desired_current = %f,    current_error = %f,    out = %f\n", master.new_instruction.arm.coordinate_def.desired_torque[5] / 158, current_error, -30 * current_error - 4.0*int_current_error);
        }
        // DUNG END
        break;
    default: // w tym miejscu nie powinien wystapic blad zwiazany z
...
/*-----------------------------------------------------------------------*/
BYTE NL_regulator_8_irp6p::compute_set_value (void)
{
    // algorytm regulacji dla serwomechanizmu
    ...
    // BY Y i S - uwzglednie ograniczen na predkosc i przyspieszenie
    constraint_detector(SG_REG_8_MAX_ACC, SG_REG_8_MAX_SPEED);

    // przeliczenie radianow na impulsy
    // step_new_pulse = step_new*IRP6_POSTUMENT_INC_PER_REVOLUTION/(2*M_PI); // ORIGINAL
    step_new_pulse = step_new*IRP6_POSTUMENT_AXE_7_INC_PER_REVOLUTION/(2*M_PI);//*AXE_7_POSTUMENT_TO_TRACK_RATIO);
