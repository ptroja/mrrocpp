...
/*-----------------------------------------------------------------------*/
NL_regulator_2_irp6p::NL_regulator_2_irp6p (BYTE reg_no, BYTE reg_par_no, double aa, double bb0, double bb1, double k_ff) 
             : NL_regulator(reg_no, reg_par_no, aa, bb0, bb1, k_ff) {
  // Konstruktor regulatora konkretnego
  // Przy inicjacji nalezy dopilnowac, zeby numery algorytmu regulacji oraz zestawu jego parametrow byly 
  // zgodne z faktycznie przekazywanym zestawem parametrow inicjujacych.
...
/*-----------------------------------------------------------------------*/
NL_regulator_3_irp6p::NL_regulator_3_irp6p (BYTE reg_no, BYTE reg_par_no, double aa, double bb0, double bb1, double k_ff) 
             : NL_regulator(reg_no, reg_par_no, aa, bb0, bb1, k_ff) {
  // Konstruktor regulatora konkretnego
  // Przy inicjacji nalezy dopilnowac, zeby numery algorytmu regulacji oraz zestawu jego parametrow byly 
  // zgodne z faktycznie przekazywanym zestawem parametrow inicjujacych.
...
/*-----------------------------------------------------------------------*/
NL_regulator_4_irp6p::NL_regulator_4_irp6p (BYTE reg_no, BYTE reg_par_no, double aa, double bb0, double bb1, double k_ff) 
             : NL_regulator(reg_no, reg_par_no, aa, bb0, bb1, k_ff) {
  // Konstruktor regulatora konkretnego
  // Przy inicjacji nalezy dopilnowac, zeby numery algorytmu regulacji oraz zestawu jego parametrow byly 
  // zgodne z faktycznie przekazywanym zestawem parametrow inicjujacych.
...
/*-----------------------------------------------------------------------*/
NL_regulator_5_irp6p::NL_regulator_5_irp6p (BYTE reg_no, BYTE reg_par_no, double aa, double bb0, double bb1, double k_ff) 
             : NL_regulator(reg_no, reg_par_no, aa, bb0, bb1, k_ff) {
  // Konstruktor regulatora konkretnego
  // Przy inicjacji nalezy dopilnowac, zeby numery algorytmu regulacji oraz zestawu jego parametrow byly 
  // zgodne z faktycznie przekazywanym zestawem parametrow inicjujacych.
...
/*-----------------------------------------------------------------------*/
NL_regulator_6_irp6p::NL_regulator_6_irp6p (BYTE reg_no, BYTE reg_par_no, double aa, double bb0, double bb1, double k_ff) 
             : NL_regulator(reg_no, reg_par_no, aa, bb0, bb1, k_ff) {
  // Konstruktor regulatora konkretnego
  // Przy inicjacji nalezy dopilnowac, zeby numery algorytmu regulacji oraz zestawu jego parametrow byly 
  // zgodne z faktycznie przekazywanym zestawem parametrow inicjujacych.
...
/*-----------------------------------------------------------------------*/
NL_regulator_7_irp6p::NL_regulator_7_irp6p (BYTE reg_no, BYTE reg_par_no, double aa, double bb0, double bb1, double k_ff) 
             : NL_regulator(reg_no, reg_par_no, aa, bb0, bb1, k_ff) {
  // Konstruktor regulatora konkretnego
  // Przy inicjacji nalezy dopilnowac, zeby numery algorytmu regulacji oraz zestawu jego parametrow byly 
  // zgodne z faktycznie przekazywanym zestawem parametrow inicjujacych.
...
/*-----------------------------------------------------------------------*/
NL_regulator_8_irp6p::NL_regulator_8_irp6p (BYTE reg_no, BYTE reg_par_no, double aa, double bb0, double bb1, double k_ff) 
             : NL_regulator(reg_no, reg_par_no, aa, bb0, bb1, k_ff) {
