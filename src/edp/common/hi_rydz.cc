...
void hardware_interface::init_inside()
{

}

void hardware_interface::init_inside_irp6ot()
{
...
// Konstruktor
hardware_interface::hardware_interface(motor_driven_effector &_master, int _hi_irq_real, unsigned short int _hi_intr_freq_divider, unsigned int _hi_intr_timeout_high, unsigned int _hi_first_servo_ptr, unsigned int _hi_intr_generator_servo_ptr, unsigned int _hi_isa_card_offset, int* _max_current) :
