...
void edp_irp6s_effector::master_joints_and_frame_download (void) { // by Y
...
void edp_irp6s_effector::master_joints_read (double* output) { // by Y
	pthread_mutex_lock( &edp_irp6s_effector_mutex );
	// przepisanie danych na zestaw lokalny dla edp_master
	for (int i=0; i < number_of_servos; i++) {
...
void edp_irp6s_effector::move_arm (c_buffer *instruction) {} // przemieszczenie ramienia

/*--------------------------------------------------------------------------*/

void edp_irp6s_effector::get_arm_position (bool read_hardware, c_buffer *instruction) {} // odczytanie pozycji ramienia
