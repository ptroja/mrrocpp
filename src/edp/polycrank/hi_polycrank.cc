		...
		_hi_intr_timeout_high, _hi_first_servo_ptr, _hi_intr_generator_servo_ptr)
{
	...
	int max_current [POLYCRANK_NUM_OF_SERVOS] = {
			POLYCRANK_AXIS_1_MAX_CURRENT,POLYCRANK_AXIS_2_MAX_CURRENT,
			POLYCRANK_AXIS_3_MAX_CURRENT, POLYCRANK_AXIS_4_MAX_CURRENT,
