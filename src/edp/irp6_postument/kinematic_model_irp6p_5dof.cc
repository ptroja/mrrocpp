...
/* -----------------------------------------------------------------------
  Konstruktor.
 ------------------------------------------------------------------------- */
kinematic_model_irp6p_5dof::kinematic_model_irp6p_5dof (void)
{
...
void kinematic_model_irp6p_5dof::set_kinematic_parameters(void)
{
  // Wysokosc kolumny.
  d1 = 0.7;
...
THETA_NODE* kinematic_model_irp6p_5dof::Theta_1(double q0[3], double v0[3],
...
THETA_NODE* kinematic_model_irp6p_5dof::Theta_4(THETA_NODE *theta1_pointer,
...
word16 kinematic_model_irp6p_5dof::QuadraticEquation(double a, double b, double c,
...
word16 kinematic_model_irp6p_5dof::Ecos_Fsin_G(double e, double f, double g,
...
word16 kinematic_model_irp6p_5dof::Check_cos_Theta1(double cos_theta1, double *sin_theta1,
			       double *theta1,
...
word16 kinematic_model_irp6p_5dof::Check_Theta5(double *theta5, double c5, double s5,
...
word16 kinematic_model_irp6p_5dof::Flange(double u0[3], double v0[3], double u6[3],
		     double radius_2,
...
word16 kinematic_model_irp6p_5dof::Flange_exception(double u0[3], double v0[3], double u6[3],
	     double radius_2,
	 THETA_NODE *theta1_pointer, THETA_NODE *theta4_pointer,
...
THETA_NODE* kinematic_model_irp6p_5dof::Add_Theta(double Theta, double cosTheta, double sinTheta)
...
THETA_NODE* kinematic_model_irp6p_5dof::Create1(double x, double p, double r, double t,
		    word16 *result,
...
void kinematic_model_irp6p_5dof::Delete_Theta_Tree(THETA_NODE *root_ptr)
