...
void edp_irp6p_effector::create_kinematic_models_for_given_robot(void)
{
	...
	add_kinematic_model(new kinematic_model_irp6p_with_wrist());
	add_kinematic_model(new kinematic_model_irp6p_5dof());
	add_kinematic_model(new kinematic_model_calibrated_irp6p_with_wrist());
	add_kinematic_model(new kinematic_model_calibrated_correction_matrix_irp6p_with_wrist());
	add_kinematic_model(new kinematic_model_irp6p_jacobian_with_wrist());
	add_kinematic_model(new kinematic_model_irp6p_jacobian_transpose_with_wrist());
	//add_kinematic_model(new kinematic_model_irp6p_jacobian_with_wrist());
