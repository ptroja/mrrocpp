...
void edp_speaker_effector::main_loop (void)
{
	...
	for (;;)
	{
		...
		{ // w tym bloku beda wylapywane wyjatki (bledy)
			...
			case common::GET_INSTRUCTION:
				...
				case SYNCHRO: // blad: robot jest juz zsynchronizowany
					...
					throw common::edp_irp6s_effector::NonFatal_error_1(ALREADY_SYNCHRONISED);
				case QUERY: // blad: nie ma o co pytac - zadne polecenie uprzednio nie zostalo wydane
					// okreslenie numeru bledu
					throw common::edp_irp6s_effector::NonFatal_error_1(QUERY_NOT_EXPECTED);
				default: // blad: nieznana instrukcja
					// okreslenie numeru bledu
					throw common::edp_irp6s_effector::NonFatal_error_1(UNKNOWN_INSTRUCTION);
				}
				...
				case common::WAIT:
					...
					{ // blad: powinna byla nadejsc instrukcja QUERY
						throw common::edp_irp6s_effector::NonFatal_error_3(QUERY_EXPECTED);
					}
		...
		catch(common::edp_irp6s_effector::NonFatal_error_1 nfe)
		{
		...
		catch(common::edp_irp6s_effector::NonFatal_error_2 nfe)
		{
			// Obsluga bledow nie fatalnych
			// Konkretny numer bledu znajduje sie w skladowej error obiektu nfe
			// S to bledy nie zwiazane ze sprzetem i komunikacja miedzyprocesow
		...
		catch(common::edp_irp6s_effector::NonFatal_error_3 nfe)
		{
			// Obsluga bledow nie fatalnych
			// Konkretny numer bledu znajduje sie w skladowej error obiektu nfe
			// S to bledy nie zwiazane ze sprzetem i komunikacja miedzyprocesow
		...
		catch(common::edp_irp6s_effector::Fatal_error fe)
		{
