...
class kinematic_model_with_local_corrector: public mrrocpp::kinematics::common::kinematic_model_with_tool
{
	...
	public:
		...
		virtual void i2e_wo_tool_transform(const std::vector<double> & local_current_joints, lib::Homog_matrix& local_current_end_effector_frame);
		...
		virtual void e2i_wo_tool_transform(std::vector<double> & local_desired_joints, std::vector<double> & local_current_joints, lib::Homog_matrix& local_desired_end_effector_frame);
