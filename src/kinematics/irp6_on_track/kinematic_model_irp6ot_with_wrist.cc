...
if (motor_position[2] < lower_limit_axis[2])   // Kat f3 mniejszy od minimalnego
  ...
  throw  common::transformer_error::NonFatal_error_2 (BEYOND_LOWER_LIMIT_AXIS_7);
else if (motor_position[7] > upper_limit_axis[7])   // Kat f8 wiekszy od maksymalnego
  throw  common::transformer_error::NonFatal_error_2 (BEYOND_UPPER_LIMIT_AXIS_7);
...
void kinematic_model_irp6ot_with_wrist::check_joints(const double q[])
{
	...
	if (isnan(q[0])) throw  common::transformer_error::NonFatal_error_2 (NOT_A_NUMBER_JOINT_VALUE_D0);

  if (q[0] < lower_limit_joint[0])  // kat q1 mniejszy od minimalnego
    throw  common::transformer_error::NonFatal_error_2 (BEYOND_LOWER_D0_LIMIT);
  else if (q[0] > upper_limit_joint[0])   // kat q1 wiekszy od maksymalnego
    throw  common::transformer_error::NonFatal_error_2 (BEYOND_UPPER_D0_LIMIT);

	if (isnan(q[1])) throw  common::transformer_error::NonFatal_error_2 (NOT_A_NUMBER_JOINT_VALUE_THETA1);
  ...
  if (q[1] > upper_limit_joint[1])  // dlugosc silownika wieksza od maksymalnej
   throw  common::transformer_error::NonFatal_error_2 (BEYOND_UPPER_THETA1_LIMIT);
	...
	if (isnan(q[2])) throw  common::transformer_error::NonFatal_error_2 (NOT_A_NUMBER_JOINT_VALUE_THETA2);
  ...
  if(q[2] > upper_limit_joint[2])  // dlugosc silownika wieksza od maksymalnej
   throw  common::transformer_error::NonFatal_error_2 (BEYOND_UPPER_THETA2_LIMIT);
	...
	if (isnan(q[3])) throw  common::transformer_error::NonFatal_error_2 (NOT_A_NUMBER_JOINT_VALUE_THETA3);
  ...
  if (q[3] > upper_limit_joint[3])
	...
	if (isnan(q[4])) throw  common::transformer_error::NonFatal_error_2 (NOT_A_NUMBER_JOINT_VALUE_THETA4);
 ...
 if(q[4] > upper_limit_joint[4])  // kat q4 wiekszy od maksymalnego
   throw  common::transformer_error::NonFatal_error_2 (BEYOND_UPPER_THETA4_LIMIT);
	...
	if (isnan(q[5])) throw  common::transformer_error::NonFatal_error_2 (NOT_A_NUMBER_JOINT_VALUE_THETA5);
 ...
 if(q[5] > upper_limit_joint[5])  // kat q5 wiekszy od maksymalnego
   throw  common::transformer_error::NonFatal_error_2 (BEYOND_UPPER_THETA5_LIMIT);
	...
	if (isnan(q[6])) throw  common::transformer_error::NonFatal_error_2 (NOT_A_NUMBER_JOINT_VALUE_THETA6);
 ...
 if(q[6] > upper_limit_joint[6])  // 6 st. swobody
   throw  common::transformer_error::NonFatal_error_2 (BEYOND_UPPER_THETA6_LIMIT);
	  ...
	  //***szczeki chwytaka***
  	if (isnan(q[7])) throw  common::transformer_error::NonFatal_error_2 (NOT_A_NUMBER_JOINT_VALUE_THETA7);
