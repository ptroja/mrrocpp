...
int16_t kinematic_model_irp6p_5dof::QuadraticEquation(double a, double b, double c,
...
int16_t kinematic_model_irp6p_5dof::Check_cos_Theta1(double cos_theta1, double *sin_theta1,
			       double *theta1,
...
int16_t kinematic_model_irp6p_5dof::Check_Theta5(double *theta5, double c5, double s5,
...
int16_t kinematic_model_irp6p_5dof::Flange(double u0[3], double v0[3], double u6[3],
		     double radius_2,
...
int16_t kinematic_model_irp6p_5dof::Flange_exception(double u0[3], double v0[3], double u6[3],
	     double radius_2,
	 THETA_NODE *theta1_pointer, THETA_NODE *theta4_pointer,
