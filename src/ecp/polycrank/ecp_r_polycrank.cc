...
robot::robot (lib::configurator &_config, lib::sr_ecp &_sr_ecp):
	ecp_robot (lib::ROBOT_POLYCRANK, POLYCRANK_NUM_OF_SERVOS, EDP_POLYCRACNK_SECTION, _config, _sr_ecp){};
robot::robot (common::task::task& _ecp_object):
	ecp_robot (lib::ROBOT_POLYCRANK, POLYCRANK_NUM_OF_SERVOS, EDP_POLYCRACNK_SECTION, _ecp_object){};
