...
robot::robot (lib::configurator &_config, lib::sr_ecp &_sr_ecp):
        ecp_robot (lib::ROBOT_CONVEYOR, CONVEYOR_NUM_OF_SERVOS, "[edp_conveyor]", _config, _sr_ecp)
{}
robot::robot (common::task::task& _ecp_object):
        ecp_robot (lib::ROBOT_CONVEYOR, CONVEYOR_NUM_OF_SERVOS, "[edp_conveyor]", _ecp_object)
{}
