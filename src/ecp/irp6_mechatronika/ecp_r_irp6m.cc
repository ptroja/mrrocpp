...
robot::robot (lib::configurator &_config, lib::sr_ecp &_sr_ecp):
	ecp_robot (lib::ROBOT_IRP6_MECHATRONIKA, IRP6_MECHATRONIKA_NUM_OF_SERVOS, EDP_IRP6_MECHATRONIKA_SECTION, _config, _sr_ecp){}
robot::robot (common::task::task& _ecp_object):
	ecp_robot (lib::ROBOT_IRP6_MECHATRONIKA, IRP6_MECHATRONIKA_NUM_OF_SERVOS, EDP_IRP6_MECHATRONIKA_SECTION, _ecp_object){}
