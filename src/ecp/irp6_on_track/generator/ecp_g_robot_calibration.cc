/*
 * generator/ecp_g_robot_calibration.cc
 * For the generators required for robot_calibration project files specifically for tasks task/ecp_t_robot_calibration.cc
...
/*	sensor->to_vsp.i_code = lib::VSP_GET_READING;
	...
	{
		// pcbird_sensor_image is a union declared in generator/ecp_g_robot_calibration.h to receive readings
