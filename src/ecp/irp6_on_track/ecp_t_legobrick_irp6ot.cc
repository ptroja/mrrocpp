...
ecp_task_lego_brick_irp6ot::~ecp_task_lego_brick_irp6ot()
{}
...
void ecp_task_lego_brick_irp6ot::main_task_algorithm(void)
{
    ...
    sr_ecp_msg->message("ECP lego brick irp6ot  - wcisnij start");
    ecp_wait_for_start();
    /*
    for(;;)
...
ecp_task* return_created_ecp_task(configurator &_config)
                {
                    return new ecp_task_lego_brick_irp6ot(_config);
                }
