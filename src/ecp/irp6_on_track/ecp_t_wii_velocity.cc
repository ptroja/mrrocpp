...
ecp_task_wii_velocity::ecp_task_wii_velocity(configurator &_config) : base(_config) {};
...
{
	eg = new generator::ecp_wii_velocity_generator(*this);
...
{
	return new irp6ot::task::ecp_task_wii_velocity(_config);
}
