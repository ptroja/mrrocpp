...
ecp_vis_ib_eih_irp6ot::ecp_vis_ib_eih_irp6ot(common::task::ecp_task& _ecp_task, int step) : common::ecp_visual_servo(_ecp_task){
...
bool ecp_vis_ib_eih_irp6ot::next_step_without_constraints(){
	...
	C_Tx_G=C_Tx_G*G_Tx_S;
	O_Tx_G=O_Tx_E*C_Tx_G; //rota O_Tx_E 0,0,0
...
#if 0
void ecp_vis_ib_eih_irp6ot::entertain_constraints(){
...
bool ecp_vis_ib_eih_irp6ot::first_step(void){
