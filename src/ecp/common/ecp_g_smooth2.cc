...
void ecp_smooth2_generator::prev_pose_list_ptr(void) {
...
void ecp_smooth2_generator::initiate_coordinate_list(void) {
...
void ecp_smooth2_generator::flush_coordinate_list(void) {
