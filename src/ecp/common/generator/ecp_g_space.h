...
public:	
   hermite_spline (common::task::task& _ecp_task, double interval, double ts );		// constructor		 
...
public:	
   natural_spline(common::task::task& _ecp_task, double interval, double ts );		// constructor		 
