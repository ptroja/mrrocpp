...
#include "ecp/common/generator/ecp_g_newsmooth.h"
...
/*void newsmooth::load_file_with_path(const char* file_name) {
    ...
    for ( i = 0; i < number_of_poses; i++)
    {
        ...
        if (first_time)
        {
            ...
            printf("Pose list element (head): %d, %f, %f\n", ps, v[0], a[0]);
            flushall();
        }
        else
        {
            // Wstaw do listy nowa pozycje
        	printf("Pose list element: %d, %f, %f\n", ps, v[0], a[0]);
        	flushall();
...
void newsmooth::load_coordinates(lib::ECP_POSE_SPECIFICATION ps, double coordinates[MAX_SERVOS_NR], bool reset) {
...
void newsmooth::load_coordinates(lib::ECP_POSE_SPECIFICATION ps, double v[MAX_SERVOS_NR], double a[MAX_SERVOS_NR], double coordinates[MAX_SERVOS_NR], bool reset){
...
void newsmooth::load_coordinates(lib::ECP_POSE_SPECIFICATION ps, double cor0, double cor1, double cor2, double cor3, double cor4, double cor5, double cor6, double cor7, bool reset) {
...
void newsmooth::load_coordinates(lib::ECP_POSE_SPECIFICATION ps, double v[MAX_SERVOS_NR], double a[MAX_SERVOS_NR], double cor0, double cor1, double cor2, double cor3, double cor4, double cor5, double cor6, double cor7, bool reset) {
...
void newsmooth::load_xyz_angle_axis(double coordinates[MAX_SERVOS_NR], bool reset) {
	load_coordinates(lib::ECP_XYZ_ANGLE_AXIS, coordinates, reset);
}
void newsmooth::load_xyz_angle_axis(double v[MAX_SERVOS_NR], double a[MAX_SERVOS_NR], double coordinates[MAX_SERVOS_NR], bool reset) {
	load_coordinates(lib::ECP_XYZ_ANGLE_AXIS, v, a, coordinates, reset);
}
void newsmooth::load_xyz_angle_axis(double cor0, double cor1, double cor2, double cor3, double cor4, double cor5, double cor6, double cor7, bool reset) {
	load_coordinates(lib::ECP_XYZ_ANGLE_AXIS, cor0, cor1, cor2, cor3, cor4, cor5, cor6, cor7, reset);
}
void newsmooth::load_xyz_angle_axis(double v[MAX_SERVOS_NR], double a[MAX_SERVOS_NR], double cor0, double cor1, double cor2, double cor3, double cor4, double cor5, double cor6, double cor7, bool reset) {
	load_coordinates(lib::ECP_XYZ_ANGLE_AXIS, v, a, cor0, cor1, cor2, cor3, cor4, cor5, cor6, cor7, reset);
}

void newsmooth::load_xyz_euler_zyz(double coordinates[MAX_SERVOS_NR], bool reset) {
	load_coordinates(lib::ECP_XYZ_EULER_ZYZ, coordinates, reset);
}
void newsmooth::load_xyz_euler_zyz(double v[MAX_SERVOS_NR], double a[MAX_SERVOS_NR], double coordinates[MAX_SERVOS_NR], bool reset) {
	load_coordinates(lib::ECP_XYZ_EULER_ZYZ, v, a, coordinates, reset);
}
void newsmooth::load_xyz_euler_zyz(double cor0, double cor1, double cor2, double cor3, double cor4, double cor5, double cor6, double cor7, bool reset) {
	load_coordinates(lib::ECP_XYZ_EULER_ZYZ, cor0, cor1, cor2, cor3, cor4, cor5, cor6, cor7, reset);
}
void newsmooth::load_xyz_euler_zyz(double v[MAX_SERVOS_NR], double a[MAX_SERVOS_NR], double cor0, double cor1, double cor2, double cor3, double cor4, double cor5, double cor6, double cor7, bool reset) {
	load_coordinates(lib::ECP_XYZ_EULER_ZYZ, v, a, cor0, cor1, cor2, cor3, cor4, cor5, cor6, cor7, reset);
}

void newsmooth::load_joint(double coordinates[MAX_SERVOS_NR], bool reset) {
	load_coordinates(lib::ECP_JOINT, coordinates, reset);
}
void newsmooth::load_joint(double v[MAX_SERVOS_NR], double a[MAX_SERVOS_NR], double coordinates[MAX_SERVOS_NR], bool reset) {
	load_coordinates(lib::ECP_JOINT, v, a, coordinates, reset);
}
void newsmooth::load_joint(double cor0, double cor1, double cor2, double cor3, double cor4, double cor5, double cor6, double cor7, bool reset) {
	load_coordinates(lib::ECP_JOINT, cor0, cor1, cor2, cor3, cor4, cor5, cor6, cor7, reset);
}
void newsmooth::load_joint(double v[MAX_SERVOS_NR], double a[MAX_SERVOS_NR], double cor0, double cor1, double cor2, double cor3, double cor4, double cor5, double cor6, double cor7, bool reset) {
	load_coordinates(lib::ECP_JOINT, v, a, cor0, cor1, cor2, cor3, cor4, cor5, cor6, cor7, reset);
}

void newsmooth::load_motor(double coordinates[MAX_SERVOS_NR], bool reset) {
	load_coordinates(lib::ECP_MOTOR, coordinates, reset);
}
void newsmooth::load_motor(double v[MAX_SERVOS_NR], double a[MAX_SERVOS_NR], double coordinates[MAX_SERVOS_NR], bool reset) {
	load_coordinates(lib::ECP_MOTOR, v, a, coordinates, reset);
}
void newsmooth::load_motor(double cor0, double cor1, double cor2, double cor3, double cor4, double cor5, double cor6, double cor7, bool reset) {
	load_coordinates(lib::ECP_MOTOR, cor0, cor1, cor2, cor3, cor4, cor5, cor6, cor7, reset);
}
void newsmooth::load_motor(double v[MAX_SERVOS_NR], double a[MAX_SERVOS_NR], double cor0, double cor1, double cor2, double cor3, double cor4, double cor5, double cor6, double cor7, bool reset) {
...
void newsmooth::next_pose_list_ptr(void) {
    if (pose_vector_iterator != pose_vector.end()) {
        pose_vector_iterator++;
    }
}

void newsmooth::prev_pose_list_ptr(void) {
	if (pose_vector_iterator != pose_vector.begin()) {
		pose_vector_iterator--;
	}
}

/*bool newsmooth::is_last_list_element(void) {
...
newsmooth::newsmooth (common::task::task& _ecp_task, bool _is_synchronised)
        :
        delta (_ecp_task), debug(false)
{
	pose_vector = vector<ecp_mp::common::bang_bang_trajectory_pose>();
	coordinate_vector = vector<coordinates>();
} // end : konstruktor
