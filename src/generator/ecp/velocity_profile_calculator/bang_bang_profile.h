...
class bang_bang_profile : public velocity_profile<ecp_mp::common::trajectory_pose::bang_bang_trajectory_pose> {
	public:
		 ...
		 * @return true if the calculation was successful
		 */
		bool set_v_k_pose(std::vector<ecp_mp::common::trajectory_pose::bang_bang_trajectory_pose>::iterator & it, std::vector<ecp_mp::common::trajectory_pose::bang_bang_trajectory_pose>::iterator & end_it);
		/**
		 ...
		 * @return true if the calculation was successful
		 */
		bool set_v_p(std::vector<ecp_mp::common::trajectory_pose::bang_bang_trajectory_pose>::iterator & it, std::vector<ecp_mp::common::trajectory_pose::bang_bang_trajectory_pose>::iterator & beginning_it, int i);
		/**
