...

{
	...
	// wychwytania ew. bledow ECP::robot
	double *wektor_ptgr[lib::irp6p_m::IRP6P_M_NUM_OF_SERVOS], wektor[lib::irp6p_m::IRP6P_M_NUM_OF_SERVOS];
...
int irp6p_int_motion(PtWidget_t *widget, ApInfo_t *apinfo,
	...
	double *wektor[lib::irp6p_m::IRP6P_M_NUM_OF_SERVOS];
	double *step1;
...

{
	...
	uint8_t servo_alg_no[lib::irp6p_m::IRP6P_M_NUM_OF_SERVOS];
	uint8_t servo_par_no[lib::irp6p_m::IRP6P_M_NUM_OF_SERVOS];
...

{
	...
	// wychwytania ew. bledow ECP::robot
	uint8_t *wektor_ptgr[lib::irp6p_m::IRP6P_M_NUM_OF_SERVOS],
			*wektor2_ptgr[lib::irp6p_m::IRP6P_M_NUM_OF_SERVOS],
			wektor[lib::irp6p_m::IRP6P_M_NUM_OF_SERVOS], wektor2[lib::irp6p_m::IRP6P_M_NUM_OF_SERVOS];
...

{
	...
	uint8_t *servo_alg_no_tmp[lib::irp6p_m::IRP6P_M_NUM_OF_SERVOS];
	uint8_t servo_alg_no_output[lib::irp6p_m::IRP6P_M_NUM_OF_SERVOS];
	uint8_t *servo_par_no_tmp[lib::irp6p_m::IRP6P_M_NUM_OF_SERVOS];
	uint8_t servo_par_no_output[lib::irp6p_m::IRP6P_M_NUM_OF_SERVOS];
...

{
	...
	if (ui.irp6p_m->pulse_reader_start_exec_pulse()) {
...

{
	...
	if (ui.irp6p_m->pulse_reader_stop_exec_pulse()) {
		process_control_window_init(widget, apinfo, cbinfo);
	}
...

{
	...
	if (ui.irp6p_m->pulse_reader_trigger_exec_pulse())
		process_control_window_init(widget, apinfo, cbinfo);
