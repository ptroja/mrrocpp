...

{
	...
	uint8_t servo_alg_no[interface.irp6p_tfg->number_of_servos];
	uint8_t servo_par_no[interface.irp6p_tfg->number_of_servos];
...

{
	...
	uint8_t *servo_alg_no_tmp[interface.irp6p_tfg->number_of_servos];
	uint8_t servo_alg_no_output[interface.irp6p_tfg->number_of_servos];
	uint8_t *servo_par_no_tmp[interface.irp6p_tfg->number_of_servos];
	uint8_t servo_par_no_output[interface.irp6p_tfg->number_of_servos];
	...
	try {
		if (interface.irp6p_tfg->state.edp.is_synchronised) {
			...
			for (int i = 0; i < interface.irp6p_tfg->number_of_servos; i++) {
