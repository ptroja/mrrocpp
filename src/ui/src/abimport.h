...
int spkm_move_to_position_0( PtWidget_t *widget, ApInfo_t *data, PtCallbackInfo_t *cbinfo );
int spkm_move_to_position_1( PtWidget_t *widget, ApInfo_t *data, PtCallbackInfo_t *cbinfo );
