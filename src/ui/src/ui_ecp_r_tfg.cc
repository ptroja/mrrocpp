...
// ZADANIE NARZEDZIA
// ---------------------------------------------------------------
void ui_tfg_robot::set_tool_xyz_angle_axis(const lib::Xyz_Angle_Axis_vector &tool_vector)
{
	ecp->ecp_command.instruction.instruction_type = lib::SET;
	ecp->ecp_command.instruction.set_type = ROBOT_MODEL_DEFINITION; // ROBOT_MODEL
...
// ZADANIE NARZEDZIA
// ---------------------------------------------------------------
void ui_tfg_robot::set_tool_xyz_euler_zyz(const lib::Xyz_Euler_Zyz_vector &tool_vector)
{
	ecp->ecp_command.instruction.instruction_type = lib::SET;
	ecp->ecp_command.instruction.set_type = ROBOT_MODEL_DEFINITION; // ROBOT_MODEL
	ecp->ecp_command.instruction.set_robot_model_type = lib::TOOL_FRAME;
...
// ODCZYT NARZEDZIA
// ---------------------------------------------------------------
void ui_tfg_robot::read_tool_xyz_angle_axis(lib::Xyz_Angle_Axis_vector & tool_vector)
{
	// Zlecenie odczytu numeru modelu i korektora kinematyki
	ecp->ecp_command.instruction.instruction_type = lib::GET;
	ecp->ecp_command.instruction.get_type = ROBOT_MODEL_DEFINITION; // ROBOT_MODEL
...
// ODCZYT NARZEDZIA
// ---------------------------------------------------------------
void ui_tfg_robot::read_tool_xyz_euler_zyz(lib::Xyz_Euler_Zyz_vector &tool_vector)
{
	// Zlecenie odczytu numeru modelu i korektora kinematyki
	ecp->ecp_command.instruction.instruction_type = lib::GET;
	ecp->ecp_command.instruction.get_type = ROBOT_MODEL_DEFINITION; // ROBOT_MODEL
...
// ---------------------------------------------------------------
void ui_tfg_robot::move_xyz_euler_zyz(const double final_position[7])
{
...
void ui_tfg_robot::move_xyz_angle_axis(const double final_position[7])
{
...
void ui_tfg_robot::move_xyz_angle_axis_relative(const double position_increment[7])
{
	int nr_of_steps; // Liczba krokow
	int nr_ang, nr_lin, nr_grip;
...
// ---------------------------------------------------------------
void ui_tfg_robot::read_xyz_euler_zyz(double current_position[])
{
	// Zlecenie odczytu polozenia
...
void ui_tfg_robot::read_xyz_angle_axis(double current_position[])
{
