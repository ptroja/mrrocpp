...
public:
	...
	double sarkofag_current_pos[lib::sarkofag::SARKOFAG_NUM_OF_SERVOS];// pozycja biezaca
	double sarkofag_desired_pos[lib::sarkofag::SARKOFAG_NUM_OF_SERVOS]; // pozycja zadana
