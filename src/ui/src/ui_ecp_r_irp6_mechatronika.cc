...
// ---------------------------------------------------------------
/* // by Y - zdefiniowane w irp6_mechatronika_robot - przemyslec czy nie trzeba wstawic warunku na poprawnosc synchronizacji
...
execute_motion();
  ...
  return true;
};// end: ui_irp6_mechatronika_robot::set_kinematic()
// ---------------------------------------------------------------
...
execute_motion();
  return true;
};// end: ui_irp6_mechatronika_robot::set_servo_algorithm()
// ---------------------------------------------------------------
...
bool ui_irp6_mechatronika_robot::read_xyz_angle_axis (double current_position[IRP6_MECHATRONIKA_NUM_OF_SERVOS])
{
