...
ui_tfg_and_conv_robot::ui_tfg_and_conv_robot(lib::configurator &_config, lib::sr_ecp &_sr_ecp_msg, lib::robot_name_t _robot_name)
{
	...
	switch (_robot_name)
	{
		...
		case lib::ROBOT_CONVEYOR:
			...
			break;
		default:
			fprintf(stderr, "ERROR: unknown robot name in ecp_robot ui_tfg_and_conv_robot::ui_tfg_and_conv_robot\n");
			ecp = NULL;
			break;
	}
...
ui_tfg_and_conv_robot::~ui_tfg_and_conv_robot()
{
	delete ecp;
}
...
/* // by Y - zdefiniowane w irp6_on_track_robot - przemyslec czy nie trzeba wstawic warunku na poprawnosc synchronizacji
 void ui_tfg_and_conv_robot::synchronise ( void ) {
 ...
 synchronised = true;
 };// end: ui_tfg_and_conv_robot::synchronise ()
 */
// ---------------------------------------------------------------
...
void ui_tfg_and_conv_robot::execute_motion(void)
{
...
// ---------------------------------------------------------------
void ui_tfg_and_conv_robot::set_desired_position(double d_position[])
{
...
// ---------------------------------------------------------------
void ui_tfg_and_conv_robot::get_current_position(double c_position[])
{
...
void ui_tfg_and_conv_robot::get_kinematic(uint8_t* kinematic_model_no)
{
...
void ui_tfg_and_conv_robot::get_servo_algorithm(uint8_t algorithm_no[], uint8_t parameters_no[])
{
...
void ui_tfg_and_conv_robot::get_controller_state(lib::controller_state_t & robot_controller_initial_state_l)
{
	// Zlecenie odczytu numeru modelu i korektora kinematyki
	ecp->ecp_command.instruction.instruction_type = lib::GET;
...
// ---------------------------------------------------------------
void ui_tfg_and_conv_robot::set_kinematic(uint8_t kinematic_model_no)
{
...
// ---------------------------------------------------------------
void ui_tfg_and_conv_robot::set_servo_algorithm(uint8_t algorithm_no[], uint8_t parameters_no[])
{
...
// ---------------------------------------------------------------
void ui_tfg_and_conv_robot::read_motors(double current_position[])
{
...
// ---------------------------------------------------------------
void ui_tfg_and_conv_robot::read_joints(double current_position[])
{
	// Zlecenie odczytu polozenia
