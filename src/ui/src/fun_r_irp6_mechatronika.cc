...
int
init_wnd_irp6m_xyz_euler_zyz_ts( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
	...
	if (ui_state.irp6_mechatronika.edp.pid!=-1)
	{
		...
		{
			ui_robot.irp6_mechatronika->read_tool_xyz_euler_zyz(tool_vector); // Odczyt polozenia walow silnikow
...
int
clear_wnd_irp6m_xyz_euler_zyz_ts_flag( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
	...
	ui_state.is_wind_irp6m_xyz_euler_zyz_ts_open = 0;
...
int
wnd_irp6m_xyz_zyz_ts_copy_cur_to_des( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
...
int
EDP_irp6_mechatronika_create( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
...
int
EDP_irp6_mechatronika_slay( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
	...
	if (ui_state.irp6_mechatronika.edp.state>0)
	 { // jesli istnieje EDP
		if(ui_state.irp6_mechatronika.edp.reader_fd >= 0) {
...
int
close_all_irp6m_windows( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
...
int
EDP_irp6_mechatronika_synchronise( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
...
int
start_wnd_irp6m_int( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
	...
	if (	!ui_state.is_wind_irp6m_int_open) // otworz okno
	{
		ApCreateModule (ABM_wnd_irp6_mechatronika_int, widget, cbinfo);
		ui_state.is_wind_irp6m_int_open=true;
...
int
start_wnd_irp6m_inc( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
	...
	if (	!ui_state.is_wind_irp6m_inc_open) // otworz okno
	{
		ApCreateModule (ABM_wnd_irp6_mechatronika_inc, widget, cbinfo);
		ui_state.is_wind_irp6m_inc_open=true;
	} else { // przelacz na okno
...
int
start_wnd_irp6m_xyz_euler_zyz( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
	...
	if (	!ui_state.is_wind_irp6m_xyz_euler_zyz_open) // otworz okno
	{
		ApCreateModule (ABM_wnd_irp6_mechatronika_xyz_euler_zyz, widget, cbinfo);
		ui_state.is_wind_irp6m_xyz_euler_zyz_open=true;
	} else { // przelacz na okno
...
int
irp6m_move_to_preset_position( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
	...
	if (ui_state.irp6_mechatronika.edp.pid!=-1) {
	 ...
	 if ((((ApName(ApWidget(cbinfo)) == ABN_mm_irp6_mechatronika_preset_position_synchro)||
		...
		)&&(ui_state.irp6_mechatronika.edp.is_synchronised)) {// powrot do pozycji synchronizacji
		 for (int i = 0; i < IRP6_MECHATRONIKA_NUM_OF_SERVOS; i++)
		 {
              irp6m_desired_pos[i] = 0;
          }
		...
		)&&(ui_state.irp6_mechatronika.edp.is_synchronised)) {// ruch do pozycji zadania (wspolrzedne przyjete arbitralnie)
		for(int i = 0; i < IRP6_MECHATRONIKA_NUM_OF_SERVOS; i++) {
	...
	} // end if (ui_state.irp6_mechatronika.edp.pid!=-1)
	} // end try
...
int
start_wnd_irp6m_xyz_euler_zyz_ts( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
	...
	if (	!ui_state.is_wind_irp6m_xyz_euler_zyz_ts_open) // otworz okno
	{
		ApCreateModule (ABM_wnd_irp6_mechatronika_xyz_euler_zyz_ts, widget, cbinfo);
		ui_state.is_wind_irp6m_xyz_euler_zyz_ts_open=1;
	} else { // przelacz na okno
...
int
start_wnd_irp6m_xyz_angle_axis_ts( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
	...
	if (	!ui_state.is_wind_irp6m_xyz_angle_axis_ts_open) // otworz okno
	{
		ApCreateModule (ABM_wnd_irp6_mechatronika_xyz_angle_axis_ts, widget, cbinfo);
		ui_state.is_wind_irp6m_xyz_angle_axis_ts_open=1;
	} else { // przelacz na okno
...
int
start_wnd_irp6m_kinematic( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
	...
	if (	!ui_state.is_wind_irp6m_kinematic_open) // otworz okno
	{
		ApCreateModule (ABM_wnd_irp6_mechatronika_kinematic, widget, cbinfo);
		ui_state.is_wind_irp6m_kinematic_open=1;
	} else { // przelacz na okno
...
int
start_wnd_irp6m_servo_algorithm( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
	...
	if (	!ui_state.is_wind_irp6m_servo_algorithm_open) // otworz okno
	{
		ApCreateModule (ABM_wnd_irp6_mechatronika_servo_algorithm, widget, cbinfo);
		ui_state.is_wind_irp6m_servo_algorithm_open=1;
	} else { // przelacz na okno
...
int
pulse_reader_irp6m_start( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
	...
	if (pulse_reader_irp6m_start_exec_pulse()) process_control_window_init(widget, apinfo, cbinfo);
...
int
pulse_reader_irp6m_stop( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
	...
	if (pulse_reader_irp6m_stop_exec_pulse()) process_control_window_init(widget, apinfo, cbinfo);
...
int
pulse_reader_irp6m_trigger( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
	...
	if (pulse_reader_irp6m_trigger_exec_pulse()) process_control_window_init(widget, apinfo, cbinfo);
...
int
pulse_ecp_irp6_mechatronika( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
...
int
wnd_irp6m_motors_copy_cur_to_des( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
	...
	// wychwytania ew. bledow ECP::robot
	double *wektor_ptgr[IRP6_MECHATRONIKA_NUM_OF_SERVOS], wektor[IRP6_MECHATRONIKA_NUM_OF_SERVOS];
...
int
irp6m_inc_motion( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
	...
	if (ui_state.irp6_mechatronika.edp.pid!=-1) {
	 ...
	 if ((ui_state.irp6_mechatronika.edp.is_synchronised)&&(ui_state.is_wind_irp6m_inc_open)) {

		PtSetResource(ABW_PtNumericFloat_wind_irp6m_inc_p0, Pt_ARG_NUMERIC_VALUE, &irp6m_desired_pos[0] , 0);
		PtSetResource(ABW_PtNumericFloat_wind_irp6m_inc_p1, Pt_ARG_NUMERIC_VALUE, &irp6m_desired_pos[1] , 0);
		PtSetResource(ABW_PtNumericFloat_wind_irp6m_inc_p2, Pt_ARG_NUMERIC_VALUE, &irp6m_desired_pos[2] , 0);
		PtSetResource(ABW_PtNumericFloat_wind_irp6m_inc_p3, Pt_ARG_NUMERIC_VALUE, &irp6m_desired_pos[3] , 0);
		PtSetResource(ABW_PtNumericFloat_wind_irp6m_inc_p4, Pt_ARG_NUMERIC_VALUE, &irp6m_desired_pos[4] , 0);
...
int
init_wnd_irp6m_inc( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
	...
	if (ui_state.irp6_mechatronika.edp.pid!=-1)
	{
		if (ui_state.irp6_mechatronika.edp.is_synchronised ) // Czy robot jest zsynchronizowany?
		{
			...
			ui_robot.irp6_mechatronika->read_motors(irp6m_current_pos); // Odczyt polozenia walow silnikow

			PtSetResource(ABW_PtNumericFloat_wind_irp6m_motors_cur_p0, Pt_ARG_NUMERIC_VALUE, &irp6m_current_pos[0] , 0);
			PtSetResource(ABW_PtNumericFloat_wind_irp6m_motors_cur_p1, Pt_ARG_NUMERIC_VALUE, &irp6m_current_pos[1] , 0);
			PtSetResource(ABW_PtNumericFloat_wind_irp6m_motors_cur_p2, Pt_ARG_NUMERIC_VALUE, &irp6m_current_pos[2] , 0);
			PtSetResource(ABW_PtNumericFloat_wind_irp6m_motors_cur_p3, Pt_ARG_NUMERIC_VALUE, &irp6m_current_pos[3] , 0);
			PtSetResource(ABW_PtNumericFloat_wind_irp6m_motors_cur_p4, Pt_ARG_NUMERIC_VALUE, &irp6m_current_pos[4] , 0);
...
int
import_wnd_irp6m_inc( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
...
int
export_wnd_irp6m_inc( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
...
int
wnd_irp6m_joints_copy_cur_to_des( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
...
int
irp6m_int_motion( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
	...
	try
	{
	if ((ui_state.irp6_mechatronika.edp.pid!=-1)&&(ui_state.irp6_mechatronika.edp.is_synchronised))
	{
		...
		if (ApName(ApWidget(cbinfo)) == ABN_PtButton_wind_irp6m_int_2l) {
			irp6m_desired_pos[1]-=(*step1);
		} else
		 if (ApName(ApWidget(cbinfo)) == ABN_PtButton_wind_irp6m_int_3l) {
			irp6m_desired_pos[2]-=(*step1);
		} else
		 if (ApName(ApWidget(cbinfo)) == ABN_PtButton_wind_irp6m_int_4l) {
			irp6m_desired_pos[3]-=(*step1);
		} else
		 if (ApName(ApWidget(cbinfo)) == ABN_PtButton_wind_irp6m_int_5l) {
			irp6m_desired_pos[4]-=(*step1);
		} else
		 if (ApName(ApWidget(cbinfo)) == ABN_PtButton_wind_irp6m_int_1r) {
			irp6m_desired_pos[0]+=*step1;
		} else
		if (ApName(ApWidget(cbinfo)) == ABN_PtButton_wind_irp6m_int_2r) {
			irp6m_desired_pos[1]+=*step1;
		} else
		 if (ApName(ApWidget(cbinfo)) == ABN_PtButton_wind_irp6m_int_3r) {
			irp6m_desired_pos[2]+=*step1;
		} else
		 if (ApName(ApWidget(cbinfo)) == ABN_PtButton_wind_irp6m_int_4r) {
			irp6m_desired_pos[3]+=*step1;
		} else
		 if (ApName(ApWidget(cbinfo)) == ABN_PtButton_wind_irp6m_int_5r) {
			irp6m_desired_pos[4]+=*step1;
		}

		ui_robot.irp6_mechatronika->move_joints(irp6m_desired_pos);

		if (ui_state.is_wind_irp6m_int_open)  // Czy robot jest zsynchronizowany?
		{

			PtSetResource(ABW_PtNumericFloat_wind_irp6m_int_p1, Pt_ARG_NUMERIC_VALUE, &irp6m_desired_pos[0] , 0);
			PtSetResource(ABW_PtNumericFloat_wind_irp6m_int_p2, Pt_ARG_NUMERIC_VALUE, &irp6m_desired_pos[1] , 0);
			PtSetResource(ABW_PtNumericFloat_wind_irp6m_int_p3, Pt_ARG_NUMERIC_VALUE, &irp6m_desired_pos[2] , 0);
			PtSetResource(ABW_PtNumericFloat_wind_irp6m_int_p4, Pt_ARG_NUMERIC_VALUE, &irp6m_desired_pos[3] , 0);
			PtSetResource(ABW_PtNumericFloat_wind_irp6m_int_p5, Pt_ARG_NUMERIC_VALUE, &irp6m_desired_pos[4] , 0);
...
int
init_wnd_irp6m_int( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
	...
	if (ui_state.irp6_mechatronika.edp.pid!=-1)
	{
		if ( ui_state.irp6_mechatronika.edp.is_synchronised )  // Czy robot jest zsynchronizowany?
		{
			ui_robot.irp6_mechatronika->read_joints(irp6m_current_pos); // Odczyt polozenia walow silnikow

		// 	unblock_widget(ABW_PtPane_wind_irp6m_int_post_synchro_moves);

			PtSetResource(ABW_PtNumericFloat_wind_irp6m_joints_cur_p1, Pt_ARG_NUMERIC_VALUE, &irp6m_current_pos[0] , 0);
			PtSetResource(ABW_PtNumericFloat_wind_irp6m_joints_cur_p2, Pt_ARG_NUMERIC_VALUE, &irp6m_current_pos[1] , 0);
			PtSetResource(ABW_PtNumericFloat_wind_irp6m_joints_cur_p3, Pt_ARG_NUMERIC_VALUE, &irp6m_current_pos[2] , 0);
			PtSetResource(ABW_PtNumericFloat_wind_irp6m_joints_cur_p4, Pt_ARG_NUMERIC_VALUE, &irp6m_current_pos[3] , 0);
			PtSetResource(ABW_PtNumericFloat_wind_irp6m_joints_cur_p5, Pt_ARG_NUMERIC_VALUE, &irp6m_current_pos[4] , 0);
...
int
import_wnd_irp6m_int( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
...
int
export_wnd_irp6m_int( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
...
int
init_wnd_irp6m_kinematic( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
	...
	if (ui_state.irp6_mechatronika.edp.pid!=-1)
	{
		if ( ui_state.irp6_mechatronika.edp.is_synchronised )  // Czy robot jest zsynchronizowany?
		{
			ui_robot.irp6_mechatronika->get_kinematic(&model_no); // Odczyt polozenia walow silnikow
...
int
irp6m_kinematic_set( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
...
int
wnd_irp6m_ser_alg_copy_cur_to_des( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
	...
	// wychwytania ew. bledow ECP::robot
	uint8_t *wektor_ptgr[IRP6_MECHATRONIKA_NUM_OF_SERVOS], *wektor2_ptgr[IRP6_MECHATRONIKA_NUM_OF_SERVOS],
...
int
init_wnd_irp6m_servo_algorithm( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
	...
	if (ui_state.irp6_mechatronika.edp.pid!=-1)
	{
		if ( ui_state.irp6_mechatronika.edp.is_synchronised )  // Czy robot jest zsynchronizowany?
		{
			ui_robot.irp6_mechatronika->get_servo_algorithm(servo_alg_no, servo_par_no); // Odczyt polozenia walow silnikow
...
int
irp6m_servo_algorithm_set( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
...
int
wnd_irp6m_xyz_aa_copy_cur_to_des( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
...
int
irp6m_xyz_angle_axis_motion( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
	...
	if ( ui_state.irp6_mechatronika.edp.is_synchronised )
	{
		...
		PtGetResource(ABW_PtNumericFloat_wind_irp6m_xyz_angle_axis_p7, Pt_ARG_NUMERIC_VALUE, &wektor_ptgr[6], 0 );
		...
		// kat obrotu
		if (ApName(ApWidget(cbinfo)) == ABN_PtButton_wind_irp6m_xyz_angle_axis_7l)
			wektor[6]-=(*krok);

		if (ApName(ApWidget(cbinfo)) == ABN_PtButton_wind_irp6m_xyz_angle_axis_7r)
			wektor[6]+=(*krok);
...
int
init_wnd_irp6m_xyz_angle_axis( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
/* eliminate 'unreferenced' warnings */
{
	widget = widget, apinfo = apinfo, cbinfo = cbinfo;
	...
	if (ui_state.irp6_mechatronika.edp.pid!=-1)
	{
		if ( ui_state.irp6_mechatronika.edp.is_synchronised )  // Czy robot jest zsynchronizowany?
		{
			ui_robot.irp6_mechatronika->read_xyz_angle_axis(irp6m_current_pos); // Odczyt polozenia walow silnikow
				printf("Blad w read read_xyz_angle_axis\n");

			PtSetResource(ABW_PtNumericFloat_wind_irp6m_xyz_angle_axis_read_p1, Pt_ARG_NUMERIC_VALUE, &irp6m_current_pos[0] , 0);
			PtSetResource(ABW_PtNumericFloat_wind_irp6m_xyz_angle_axis_read_p2, Pt_ARG_NUMERIC_VALUE, &irp6m_current_pos[1] , 0);
			PtSetResource(ABW_PtNumericFloat_wind_irp6m_xyz_angle_axis_read_p3, Pt_ARG_NUMERIC_VALUE, &irp6m_current_pos[2] , 0);
			...
			PtSetResource(ABW_PtNumericFloat_wind_irp6m_xyz_angle_axis_read_p4, Pt_ARG_NUMERIC_VALUE, &kx , 0);
			PtSetResource(ABW_PtNumericFloat_wind_irp6m_xyz_angle_axis_read_p5, Pt_ARG_NUMERIC_VALUE, &ky , 0);
			PtSetResource(ABW_PtNumericFloat_wind_irp6m_xyz_angle_axis_read_p6, Pt_ARG_NUMERIC_VALUE, &kz , 0);
			PtSetResource(ABW_PtNumericFloat_wind_irp6m_xyz_angle_axis_read_p7, Pt_ARG_NUMERIC_VALUE, &alfa , 0);
...
int
init_wnd_irp6m_xyz_aa_ts( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
	...
	if (ui_state.irp6_mechatronika.edp.pid!=-1)
	{
		if ( ui_state.irp6_mechatronika.edp.is_synchronised )  // Czy robot jest zsynchronizowany?
		{
			...
			ui_robot.irp6_mechatronika->read_tool_xyz_angle_axis(tool_vector); // Odczyt polozenia walow silnikow
			...
			PtSetResource(ABW_PtNumericFloat_wind_irp6m_xyz_angle_axis_ts_read_p4, Pt_ARG_NUMERIC_VALUE, &kx , 0);
			PtSetResource(ABW_PtNumericFloat_wind_irp6m_xyz_angle_axis_ts_read_p5, Pt_ARG_NUMERIC_VALUE, &ky , 0);
			PtSetResource(ABW_PtNumericFloat_wind_irp6m_xyz_angle_axis_ts_read_p6, Pt_ARG_NUMERIC_VALUE, &kz , 0);
			PtSetResource(ABW_PtNumericFloat_wind_irp6m_xyz_angle_axis_ts_read_p7, Pt_ARG_NUMERIC_VALUE, &alfa , 0);
...
int
irp6m_xyz_angle_axis_set_tool( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
	...
	if ( ui_state.irp6_mechatronika.edp.is_synchronised )
	{
		...
		PtGetResource(ABW_PtNumericFloat_wind_irp6m_xyz_angle_axis_ts_p7, Pt_ARG_NUMERIC_VALUE, &wektor_ptgr[6], 0 );
...
int
wnd_irp6m_xyz_aa_ts_copy_cur_to_des( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
...
int
wnd_irp6m_xyz_zyz_copy_cur_to_des( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
...
int
irp6m_xyz_euler_zyz_motion( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
	...
	PtSetResource(ABW_PtNumericFloat_wind_irp6m_xyz_euler_zyz_p1, Pt_ARG_NUMERIC_VALUE, &irp6m_desired_pos[0] , 0);
	PtSetResource(ABW_PtNumericFloat_wind_irp6m_xyz_euler_zyz_p2, Pt_ARG_NUMERIC_VALUE, &irp6m_desired_pos[1] , 0);
	PtSetResource(ABW_PtNumericFloat_wind_irp6m_xyz_euler_zyz_p3, Pt_ARG_NUMERIC_VALUE, &irp6m_desired_pos[2] , 0);
	PtSetResource(ABW_PtNumericFloat_wind_irp6m_xyz_euler_zyz_p4, Pt_ARG_NUMERIC_VALUE, &irp6m_desired_pos[3] , 0);
	PtSetResource(ABW_PtNumericFloat_wind_irp6m_xyz_euler_zyz_p5, Pt_ARG_NUMERIC_VALUE, &irp6m_desired_pos[4] , 0);
	PtSetResource(ABW_PtNumericFloat_wind_irp6m_xyz_euler_zyz_p6, Pt_ARG_NUMERIC_VALUE, &irp6m_desired_pos[5] , 0);
...
int
init_wnd_irp6m_xyz_euler_zyz( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
	...
	if (ui_state.irp6_mechatronika.edp.pid!=-1)
	{
		if ( ui_state.irp6_mechatronika.edp.is_synchronised )  // Czy robot jest zsynchronizowany?
		{
			ui_robot.irp6_mechatronika->read_xyz_euler_zyz(irp6m_current_pos); // Odczyt polozenia walow silnikow

			PtSetResource(ABW_PtNumericFloat_wind_irp6m_xyz_euler_zyz_read_p1, Pt_ARG_NUMERIC_VALUE, &irp6m_current_pos[0] , 0);
			PtSetResource(ABW_PtNumericFloat_wind_irp6m_xyz_euler_zyz_read_p2, Pt_ARG_NUMERIC_VALUE, &irp6m_current_pos[1] , 0);
			PtSetResource(ABW_PtNumericFloat_wind_irp6m_xyz_euler_zyz_read_p3, Pt_ARG_NUMERIC_VALUE, &irp6m_current_pos[2] , 0);
			PtSetResource(ABW_PtNumericFloat_wind_irp6m_xyz_euler_zyz_read_p4, Pt_ARG_NUMERIC_VALUE, &irp6m_current_pos[3] , 0);
			PtSetResource(ABW_PtNumericFloat_wind_irp6m_xyz_euler_zyz_read_p5, Pt_ARG_NUMERIC_VALUE, &irp6m_current_pos[4] , 0);
			PtSetResource(ABW_PtNumericFloat_wind_irp6m_xyz_euler_zyz_read_p6, Pt_ARG_NUMERIC_VALUE, &irp6m_current_pos[5] , 0);
...
int
import_wnd_irp6m_xyz_euler_zyz( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
...
int
export_wnd_irp6m_xyz_euler_zyz( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
	...
	PtGetResource(ABW_PtNumericFloat_wind_irp6m_xyz_euler_zyz_p6, Pt_ARG_NUMERIC_VALUE, &wektor[5], 0 );
      ...
      sprintf(buffer, "EDP_IRP6_M XYZ_EULER_ZYZ POSITION\n %f %f %f %f %f %f",
		*wektor[0], *wektor[1], *wektor[2], *wektor[3],  *wektor[4], *wektor[5] );
...
int
irp6m_xyz_euler_zyz_set_tool( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
...
int
clear_wnd_irp6m_inc_flag( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
...
int
clear_wnd_irp6m_int_flag( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
...
int
clear_wnd_irp6m_kinematic_flag( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )

	{
	/* eliminate 'unreferenced' warnings */
	widget = widget, apinfo = apinfo, cbinfo = cbinfo;

	ui_state.is_wind_irp6m_kinematic_open = 0;
...
int
clear_wnd_irp6m_servo_algorithm_flag( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
...
int
clear_wnd_irp6m_xyz_angle_axis_flag( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
...
int
clear_wnd_irp6m_xyz_aa_ts_flag( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
	...
	ui_state.is_wind_irp6m_xyz_angle_axis_ts_open=0;
...
int
clear_wnd_irp6m_xyz_euler_zyz_flag( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
...
int
close_wnd_irp6_mechatronika_inc( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
	...
	if (ui_state.is_wind_irp6m_inc_open)
	{
...
int
close_wnd_irp6_mechatronika_int( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
	...
	if (ui_state.is_wind_irp6m_int_open)
	{
...
int
close_wnd_irp6_mechatronika_xyz_angle_axis( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
	...
	if (ui_state.is_wind_irp6m_xyz_angle_axis_open)
	{
...
int
close_wnd_irp6_mechatronika_xyz_euler_zyz( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
	...
	if (ui_state.is_wind_irp6m_xyz_euler_zyz_open)
	{
...
int
close_wnd_irp6_mechatronika_xyz_euler_zyz_ts( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
	...
	if (ui_state.is_wind_irp6m_xyz_euler_zyz_ts_open)
	{
...
int
close_wnd_irp6_mechatronika_kinematic( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
	...
	if (ui_state.is_wind_irp6m_kinematic_open)
	{
...
int
close_wnd_irp6_mechatronika_servo_algorithm( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
	...
	if (ui_state.is_wind_irp6m_servo_algorithm_open)
	{
...
int
close_wnd_irp6_mechatronika_xyz_angle_axis_ts( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
	...
	if (ui_state.is_wind_irp6m_xyz_angle_axis_ts_open)
	{
...
int
start_wnd_irp6m_xyz_angle_axis( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
	...
	if (	!ui_state.is_wind_irp6m_xyz_angle_axis_open) // otworz okno
	{
		ApCreateModule (ABM_wnd_irp6_mechatronika_xyz_angle_axis, widget, cbinfo);
		ui_state.is_wind_irp6m_xyz_angle_axis_open=true;
	} else { // przelacz na okno
	...
	if (ui_state.irp6_mechatronika.edp.state<=0) {// edp wylaczone
		...
		block_widget(ABW_PtButton_wnd_processes_control_irp6m_reader_trigger);
		 ...
		 if (ui_state.irp6_mechatronika.edp.state==1) {// edp wlaczone reader czeka na start
			...
			unblock_widget(ABW_PtButton_wnd_processes_control_irp6m_reader_start);
			block_widget(ABW_PtButton_wnd_processes_control_irp6m_reader_stop);
			block_widget(ABW_PtButton_wnd_processes_control_irp6m_reader_trigger);
			...
			unblock_widget(ABW_PtButton_wnd_processes_control_irp6m_reader_trigger);
		}
	}

	ui_state.irp6_mechatronika.edp.last_state=ui_state.irp6_mechatronika.edp.state;
