	...
	try { // dla bledow robot :: ECP_error
		...
		if (ui_state.irp6ot_tfg.edp.state == 0) {
			...
			if ((!(ui_state.irp6ot_tfg.edp.test_mode)) && (access(
				...
				ui_state.irp6ot_tfg.edp.node_nr
...
int reload_irp6ot_tfg_configuration() {
	...
	if ((ui_state.irp6ot_tfg.is_active = ui.config->value<int> (
		...
		case 0:
			...
			if (ui.config->exists("test_mode",
					ui_state.irp6ot_tfg.edp.section_name))
				ui_state.irp6ot_tfg.edp.test_mode = ui.config->value<int> (
			...
			ui_state.irp6ot_tfg.edp.node_name = ui.config->value<std::string> (
