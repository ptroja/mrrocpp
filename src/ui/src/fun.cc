...
// blokowanie widgetu
int
block_widget ( PtWidget_t *widget)
{
...
int
unblock_widget ( PtWidget_t *widget)
{
...
// odblokowanie widgetu
int
set_ui_busy_state_notification (PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo)
{
...
int
set_ui_ready_state_notification (PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo)
{
...
int
close_process_control_window( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
...
int
clear_teaching_window_flag( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
...
int
clear_file_selection_window_flag( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
...
int
clear_wnd_process_control_flag( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
...
int
start_process_control_window( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
...
int
clear_task_config_window_flag( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
...
int
start_task_config_window( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
{
...
int
yes_no_callback( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
{
...
int
input_integer_callback( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
...
int
input_double_callback( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
...
int
choose_option_callback( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
...
int
close_file_selection_window( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
...
int
close_teaching_window( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
...
int
close_task_config_window( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
...
int
init_teaching_window( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
...
int
teaching_window_end_motion( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
...
int
file_selection_window_send_location( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
{
	...
	if (item!=NULL) {
		if (ui_state.file_window_mode==FSTRAJECTORY)
		{
			...
			{
				strncpy(ui_ecp_obj->ui_rep.filename,rindex(item->fullpath,'/')+1,strlen(rindex(item->fullpath,'/'))-1);
				ui_ecp_obj->ui_rep.filename[strlen(rindex(item->fullpath,'/'))-1]='\0';
				strncpy(ui_ecp_obj->ui_rep.path,item->fullpath,strlen(item->fullpath)-strlen(rindex(item->fullpath,'/')));
...
int
file_selection_window_post_realize( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
		...
		case FSTRAJECTORY:
		    ...
		    while((p != NULL)&&(wyjscie))
			{
				...
				item_list = PtFSAllItems( ABW_PtFileSel_sl,   NULL );
					...
					item=*item_list;
					if (strcmp(item->fullpath,current_path)==0) wyjscie++;
...
int
close_base_window( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
...
int
process_control_window_init( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
...
int
block_all_ecp_trigger_widgets( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
...
int
unblock_all_ecp_trigger_widgets( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
...
int
task_param_actualization( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
...
int
task_window_param_actualization( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
...
int initiate_configuration()
{
	...
	while (!wyjscie)
	{
		...
		std::string attach_point = config->return_attach_point_name(lib::configurator::CONFIG_SERVER, "sr_attach_point", UI_SECTION);
...
int
manage_configuration_file( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
...
int
start_file_window( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
{
	/* eliminate 'unreferenced' warnings */
	widget = widget, apinfo = apinfo, cbinfo = cbinfo;
...
//			printf("UI_ALL_EDPS_LOADED_AND_SYNCHRONISED\n");
			...
			switch (ui_state.mp.state)
			{
				...
				break;
				case UI_MP_PERMITED_TO_RUN:
					ApModifyItemState( &all_robots_menu, AB_ITEM_NORMAL, ABN_mm_all_robots_edp_unload,
...
int
clear_console ( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
{
	...
	do {
		PtMultiTextInfo(ABW_PtMultiText_sr_window, Pt_MT_QUERY_LINE, NULL, &cur_line, NULL, NULL, NULL,
			&line_width, NULL, NULL);
		if (line_width!=0) PtMultiTextModifyText(ABW_PtMultiText_sr_window, 0, line_width, NULL, NULL,
			NULL, &attr, attributes_mask);
	} while (line_width!=0);
...
int
unload_all( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
...
int
slay_all( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
	{
...
int
activate_robot_menu( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
...
int
close_yes_no_window( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
...
int
close_input_integer_window( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
...
int
close_input_double_window( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
...
int
close_choose_option_window( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
...
int
EDP_all_robots_synchronise( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
...
int
teaching_window_send_move( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
{
...
int
all_robots_move_to_preset_position( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
...
int
EDP_all_robots_create( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
...
int
EDP_all_robots_slay( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
...
int
pulse_start_mp( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
...
int
pulse_stop_mp( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
...
int
pulse_pause_mp( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
...
int
pulse_resume_mp( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
...
int
pulse_trigger_mp( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
...
int
signal_mp( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
...
int
pulse_reader_all_robots_start( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
...
int
pulse_reader_all_robots_stop( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
...
int
pulse_reader_all_robots_trigger( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
...
int
pulse_ecp_all_robots( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
