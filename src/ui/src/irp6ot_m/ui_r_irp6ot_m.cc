...
int UiRobot::process_control_window_irp6ot_section_init(bool &wlacz_PtButton_wnd_processes_control_all_reader_start, bool &wlacz_PtButton_wnd_processes_control_all_reader_stop, bool &wlacz_PtButton_wnd_processes_control_all_reader_trigger)
{
	...
	if (state.edp.state <= 0) {// edp wylaczone
		...
		if (state.edp.state == 1) {// edp wlaczone reader czeka na start
			...
			ui.unblock_widget(ABW_PtButton_wnd_processes_control_irp6ot_reader_start);
			ui.block_widget(ABW_PtButton_wnd_processes_control_irp6ot_reader_stop);
			ui.block_widget(ABW_PtButton_wnd_processes_control_irp6ot_reader_trigger);
			...
			ui.block_widget(ABW_PtButton_wnd_processes_control_irp6ot_reader_start);
			ui.unblock_widget(ABW_PtButton_wnd_processes_control_irp6ot_reader_stop);
			ui.unblock_widget(ABW_PtButton_wnd_processes_control_irp6ot_reader_trigger);
		}
	}
