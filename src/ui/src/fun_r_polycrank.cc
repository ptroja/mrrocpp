...
int
init_wnd_polycrank_xyz_euler_zyz_ts( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
...
int
clear_wnd_polycrank_xyz_euler_zyz_ts_flag( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
...
int
wnd_polycrank_xyz_zyz_ts_copy_cur_to_des( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
...
int
EDP_polycrank_create( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
...
int
EDP_polycrank_slay( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
...
int
close_all_polycrank_windows( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
...
int
EDP_polycrank_synchronise( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
...
int
start_wnd_polycrank_int( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
...
int
start_wnd_polycrank_inc( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
...
int
start_wnd_polycrank_xyz_euler_zyz( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
...
int
polycrank_move_to_preset_position( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
...
int
start_wnd_polycrank_xyz_euler_zyz_ts( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
...
int
start_wnd_polycrank_xyz_angle_axis_ts( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
...
int
start_wnd_polycrank_kinematic( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
...
int
start_wnd_polycrank_servo_algorithm( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
...
int
pulse_reader_polycrank_start( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
...
int
pulse_reader_polycrank_stop( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
...
int
pulse_reader_polycrank_trigger( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
...
int
pulse_ecp_polycrank( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
...
int
wnd_polycrank_motors_copy_cur_to_des( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
...
int
init_wnd_polycrank_inc( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
	...
	if (ui_state.irp6_mechatronika.edp.pid!=-1)
	{
		if (ui_state.irp6_mechatronika.edp.is_synchronised ) // Czy robot jest zsynchronizowany?
		{
			...
			if (!( ui_robot.irp6_mechatronika->read_motors(irp6m_current_pos))) // Odczyt polozenia walow silnikow
...
int
import_wnd_polycrank_inc( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
...
int
export_wnd_polycrank_inc( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
...
int
wnd_polycrank_joints_copy_cur_to_des( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
...
int
init_wnd_polycrank_int( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
	...
	if (ui_state.irp6_mechatronika.edp.pid!=-1)
	{
		if ( ui_state.irp6_mechatronika.edp.is_synchronised )  // Czy robot jest zsynchronizowany?
		{
			if (!(ui_robot.irp6_mechatronika->read_joints(irp6m_current_pos))) // Odczyt polozenia walow silnikow
...
int
import_wnd_polycrank_int( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
...
int
export_wnd_polycrank_int( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
...
int
init_wnd_polycrank_kinematic( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
	...
	if (ui_state.irp6_mechatronika.edp.pid!=-1)
	{
		if ( ui_state.irp6_mechatronika.edp.is_synchronised )  // Czy robot jest zsynchronizowany?
		{
			if (!(ui_robot.irp6_mechatronika->get_kinematic(&model_no))) // Odczyt polozenia walow silnikow
				printf("Blad w read external\n");
...
int
wnd_polycrank_ser_alg_copy_cur_to_des( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
...
int
init_wnd_polycrank_servo_algorithm( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
...
int
wnd_polycrank_xyz_aa_copy_cur_to_des( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
...
int
init_wnd_polycrank_xyz_angle_axis( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
/* eliminate 'unreferenced' warnings */
{
	widget = widget, apinfo = apinfo, cbinfo = cbinfo;
...
int
init_wnd_polycrank_xyz_aa_ts( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
	...
	if (ui_state.irp6_mechatronika.edp.pid!=-1)
	{
		if ( ui_state.irp6_mechatronika.edp.is_synchronised )  // Czy robot jest zsynchronizowany?
		{
			if (!(ui_robot.irp6_mechatronika->read_tool_xyz_angle_axis(tool_vector))) // Odczyt polozenia walow silnikow
				printf("Blad w read external\n");
...
int
wnd_polycrank_xyz_aa_ts_copy_cur_to_des( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
...
int
wnd_polycrank_xyz_zyz_copy_cur_to_des( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
...
int
init_wnd_polycrank_xyz_euler_zyz( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
	...
	if (ui_state.irp6_mechatronika.edp.pid!=-1)
	{
		if ( ui_state.irp6_mechatronika.edp.is_synchronised )  // Czy robot jest zsynchronizowany?
		{
			if (!(ui_robot.irp6_mechatronika->read_xyz_euler_zyz(irp6m_current_pos))) // Odczyt polozenia walow silnikow
				printf("Blad w read external\n");
...
int
import_wnd_polycrank_xyz_euler_zyz( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
...
int
export_wnd_polycrank_xyz_euler_zyz( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
...
int
clear_wnd_polycrank_inc_flag( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
...
int
clear_wnd_polycrank_int_flag( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
...
int
clear_wnd_polycrank_kinematic_flag( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
...
int
clear_wnd_polycrank_servo_algorithm_flag( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
...
int
clear_wnd_polycrank_xyz_angle_axis_flag( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
...
int
clear_wnd_polycrank_xyz_aa_ts_flag( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
...
int
clear_wnd_polycrank_xyz_euler_zyz_flag( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
...
int
close_wnd_polycrank_inc( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
...
int
close_wnd_polycrank_int( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
...
int
close_wnd_polycrank_xyz_angle_axis( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
...
int
close_wnd_polycrank_xyz_euler_zyz( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
...
int
close_wnd_polycrank_xyz_euler_zyz_ts( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
...
int
close_wnd_polycrank_kinematic( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
...
int
close_wnd_polycrank_servo_algorithm( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
...
int
close_wnd_polycrank_xyz_angle_axis_ts( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
...
int
start_wnd_polycrank_xyz_angle_axis( PtWidget_t *widget, ApInfo_t *apinfo, PtCallbackInfo_t *cbinfo )
...
int
process_control_window_polycrank_section_init (bool &wlacz_PtButton_wnd_processes_control_all_reader_start,
