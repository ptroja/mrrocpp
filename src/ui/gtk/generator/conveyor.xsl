...
<!--
MRROC++ GUI generator
Servo_algoritgm and moves windows for conveyor
 -->
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
<xsl:output method="xml" doctype-system="glade-2.0.dtd" indent="yes" version="1.0"/>

<!-- addition for conveyor servo algorithm part -->
<xsl:template name="conveyor.servo" match="conveyor">
<xsl:variable name="irp6EDPNumber" select="1"/>
<xsl:document method="xml" doctype-system="glade-2.0.dtd" indent="yes" version="1.0" href="../conveyor_servo_algorithm.glade">
<glade-interface>
...
<!-- call loop for each position -->
		<xsl:call-template name="for.each.edp.conveyor.servo">
...
<!-- addition for conveyor moves part -->
<xsl:template name="conveyor.moves" match="conveyor">
<xsl:document method="xml" doctype-system="glade-2.0.dtd" indent="yes" version="1.0" href="../conveyor_moves.glade">
              ...
              <widget class="GtkTable" id="table1">
                ...
                <child>
                  <widget class="GtkVBox" id="vbox2">
                    ...
                    <child>
                      <widget class="GtkLabel" id="labelDown2">
                        <property name="visible">True</property>
                ...
                <child>
                  <widget class="GtkVBox" id="vbox1">
                    <property name="visible">True</property>
                    <child>
                      <widget class="GtkSpinButton" id="spinbuttonDown2">
                        <property name="visible">True</property>
                        <property name="can_focus">True</property>
                        <property name="adjustment">0 0 100 1 10 10</property>
                        <property name="digits">3</property>
                ...
                <child>
                  <widget class="GtkLabel" id="label7">
                    <property name="visible">True</property>
                    <property name="label" translatable="yes">Joints &amp; 
external
 moves</property>
                  </widget>
                  <packing>
                ...
                <child>
                  <widget class="GtkLabel" id="label2">
                    <property name="visible">True</property>
                    <property name="label" translatable="yes">axis 0</property>
                  </widget>
                  <packing>
                    <property name="top_attach">3</property>
                    <property name="bottom_attach">4</property>
                ...
                <child>
                  <widget class="GtkLabel" id="label1">
                    <property name="visible">True</property>
                    <property name="label" translatable="yes">Motors
moves</property>
                  </widget>
                  <packing>
                    <property name="top_attach">2</property>
...
<!-- conveyor servo algorithm repeatable part -->
<xsl:template name="for.each.edp.conveyor.servo">
