...
#include <glib.h>
#include "ui_model.h"
#include "edp_conveyor_rcsc_uimodule.h"


edp_conveyor_rcsc::edp_conveyor_rcsc(ui_config_entry &entry)
{	
}

edp_conveyor_rcsc::~edp_conveyor_rcsc()
{
}

static edp_conveyor_rcsc *edp_conveyor;


extern "C" 
{ 
	void  on_combobox1_changed_conveyor(GtkComboBox *comboBox, gpointer userdata)  
	{
		...
		switch (choice)
		{
		case 0: std::cout << "Servo algorithm window chosen" << std::endl; ChosenFile = "conveyor_servo_algorithm.xml"; isFile = 1; break;
		case 1: std::cout << "Internal window chosen" << std::endl; ChosenFile = "conveyor_int.xml"; isFile = 1; break;
		case 2: std::cout << "Increment window chosen" << std::endl; ChosenFile = "conveyor_inc.xml"; isFile = 1; break;
		case 3:  break;
		case 4:  break;
		case 5:  break;
		case 6:  break;
	...
	{
		edp_conveyor = new edp_conveyor_rcsc(entry);
		fprintf(stderr, "module %s loaded\n", __FILE__);
		
		const char * def_servo_algorithm = "conveyor_servo_algorithm.xml"; new ui_config_entry(ui_config_entry::EDP, "edp_conveyor_servo_algorithm", NULL, def_servo_algorithm);
		const char * def_int = "conveyor_int.xml"; new ui_config_entry(ui_config_entry::EDP, "edp_conveyor_int", NULL, def_int);
		const char * def_inc = "conveyor_inc.xml"; new ui_config_entry(ui_config_entry::EDP, "edp_conveyor_inc", NULL, def_inc);
